...
public class Neeko {
    ...
    @SerializedName("info")
    private Info__79 info;
    @SerializedName("image")
    private Image__79 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__79 stats;
    ...
    @SerializedName("info")
    public Info__79 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__79 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__79 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__79 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__79 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__79 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Neeko.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Neeko) == false) {
            return false;
        }
        Neeko rhs = ((Neeko) other);
