...
public class Nami {
    ...
    @SerializedName("info")
    private Info__76 info;
    @SerializedName("image")
    private Image__76 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__76 stats;
    ...
    @SerializedName("info")
    public Info__76 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__76 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__76 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__76 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__76 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__76 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Nami.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
