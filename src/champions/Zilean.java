...
public class Zilean {
    ...
    @SerializedName("info")
    private Info__145 info;
    @SerializedName("image")
    private Image__145 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__145 stats;
    ...
    @SerializedName("info")
    public Info__145 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__145 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__145 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__145 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__145 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__145 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Zilean.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
