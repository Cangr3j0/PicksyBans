...
public class Image__41 {
    ...
    public String toString() {
        ...
        sb.append(Image__41 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__41) == false) {
            return false;
        }
        Image__41 rhs = ((Image__41) other);
