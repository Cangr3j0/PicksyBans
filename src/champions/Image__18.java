...
public class Image__18 {
    ...
    public String toString() {
        ...
        sb.append(Image__18 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__18) == false) {
            return false;
        }
        Image__18 rhs = ((Image__18) other);
