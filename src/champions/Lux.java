...
public class Lux {
    ...
    @SerializedName("info")
    private Info__67 info;
    @SerializedName("image")
    private Image__67 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__67 stats;
    ...
    @SerializedName("info")
    public Info__67 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__67 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__67 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__67 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__67 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__67 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Lux.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
