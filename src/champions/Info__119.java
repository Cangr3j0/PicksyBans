...
public class Info__119 {
    ...
    public String toString() {
        ...
        sb.append(Info__119 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__119) == false) {
            return false;
        }
        Info__119 rhs = ((Info__119) other);
