...
public class Soraka {
    ...
    @SerializedName("info")
    private Info__110 info;
    @SerializedName("image")
    private Image__110 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__110 stats;
    ...
    @SerializedName("info")
    public Info__110 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__110 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__110 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__110 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__110 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__110 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Soraka.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
