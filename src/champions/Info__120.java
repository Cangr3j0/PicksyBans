...
public class Info__120 {
    ...
    public String toString() {
        ...
        sb.append(Info__120 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__120) == false) {
            return false;
        }
        Info__120 rhs = ((Info__120) other);
