...
public class Image__83 {
    ...
    public String toString() {
        ...
        sb.append(Image__83 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__83) == false) {
            return false;
        }
        Image__83 rhs = ((Image__83) other);
