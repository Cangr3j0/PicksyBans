...
public class Info__53 {
    ...
    public String toString() {
        ...
        sb.append(Info__53 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__53) == false) {
            return false;
        }
        Info__53 rhs = ((Info__53) other);
