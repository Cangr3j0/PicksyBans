...
public class Shen {
    ...
    @SerializedName("info")
    private Info__103 info;
    @SerializedName("image")
    private Image__103 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__103 stats;
    ...
    @SerializedName("info")
    public Info__103 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__103 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__103 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__103 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__103 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__103 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Shen.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
