...
public class Image__99 {
    ...
    public String toString() {
        ...
        sb.append(Image__99 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__99) == false) {
            return false;
        }
        Image__99 rhs = ((Image__99) other);
