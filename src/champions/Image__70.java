...
public class Image__70 {
    ...
    public String toString() {
        ...
        sb.append(Image__70 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__70) == false) {
            return false;
        }
        Image__70 rhs = ((Image__70) other);
