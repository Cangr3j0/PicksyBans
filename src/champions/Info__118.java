...
public class Info__118 {
    ...
    public String toString() {
        ...
        sb.append(Info__118 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__118) == false) {
            return false;
        }
        Info__118 rhs = ((Info__118) other);
