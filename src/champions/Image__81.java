...
public class Image__81 {
    ...
    public String toString() {
        ...
        sb.append(Image__81 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__81) == false) {
            return false;
        }
        Image__81 rhs = ((Image__81) other);
