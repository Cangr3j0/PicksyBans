...
public class Kassadin {
    ...
    @SerializedName("info")
    private Info__52 info;
    @SerializedName("image")
    private Image__52 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__52 stats;
    ...
    @SerializedName("info")
    public Info__52 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__52 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__52 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__52 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__52 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__52 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Kassadin.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
