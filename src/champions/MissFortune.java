...
public class MissFortune {
    ...
    @SerializedName("info")
    private Info__72 info;
    @SerializedName("image")
    private Image__72 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__72 stats;
    ...
    @SerializedName("info")
    public Info__72 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__72 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__72 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__72 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__72 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__72 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(MissFortune.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
