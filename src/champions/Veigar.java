...
public class Veigar {
    ...
    @SerializedName("info")
    private Info__129 info;
    @SerializedName("image")
    private Image__129 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__129 stats;
    ...
    @SerializedName("info")
    public Info__129 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__129 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__129 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__129 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__129 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__129 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Veigar.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
