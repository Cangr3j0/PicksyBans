...
public class Image__53 {
    ...
    public String toString() {
        ...
        sb.append(Image__53 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__53) == false) {
            return false;
        }
        Image__53 rhs = ((Image__53) other);
