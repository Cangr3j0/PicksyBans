...
public class Info__105 {
    ...
    public String toString() {
        ...
        sb.append(Info__105 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__105) == false) {
            return false;
        }
        Info__105 rhs = ((Info__105) other);
