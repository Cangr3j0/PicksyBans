...
public class Image__45 {
    ...
    public String toString() {
        ...
        sb.append(Image__45 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__45) == false) {
            return false;
        }
        Image__45 rhs = ((Image__45) other);
