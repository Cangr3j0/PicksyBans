...
public class Info__84 {
    ...
    public String toString() {
        ...
        sb.append(Info__84 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__84) == false) {
            return false;
        }
        Info__84 rhs = ((Info__84) other);
