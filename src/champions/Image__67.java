...
public class Image__67 {
    ...
    public String toString() {
        ...
        sb.append(Image__67 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__67) == false) {
            return false;
        }
        Image__67 rhs = ((Image__67) other);
