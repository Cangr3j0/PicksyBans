...
public class Twitch {
    ...
    @SerializedName("info")
    private Info__124 info;
    @SerializedName("image")
    private Image__124 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__124 stats;
    ...
    @SerializedName("info")
    public Info__124 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__124 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__124 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__124 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__124 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__124 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Twitch.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
