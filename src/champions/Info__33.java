...
public class Info__33 {
    ...
    public String toString() {
        ...
        sb.append(Info__33 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__33) == false) {
            return false;
        }
        Info__33 rhs = ((Info__33) other);
