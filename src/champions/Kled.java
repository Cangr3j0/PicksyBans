...
public class Kled {
    ...
    @SerializedName("info")
    private Info__59 info;
    @SerializedName("image")
    private Image__59 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__59 stats;
    ...
    @SerializedName("info")
    public Info__59 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__59 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__59 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__59 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__59 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__59 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Kled.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Kled) == false) {
            return false;
        }
        Kled rhs = ((Kled) other);
