...
public class Info__51 {
    ...
    public String toString() {
        ...
        sb.append(Info__51 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__51) == false) {
            return false;
        }
        Info__51 rhs = ((Info__51) other);
