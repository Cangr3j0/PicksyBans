...
public class Image__142 {
    ...
    public String toString() {
        ...
        sb.append(Image__142 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__142) == false) {
            return false;
        }
        Image__142 rhs = ((Image__142) other);
