...
public class Image__57 {
    ...
    public String toString() {
        ...
        sb.append(Image__57 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__57) == false) {
            return false;
        }
        Image__57 rhs = ((Image__57) other);
