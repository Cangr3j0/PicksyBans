...
public class Camille {
    ...
    @SerializedName("info")
    private Info__16 info;
    @SerializedName("image")
    private Image__16 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__16 stats;
    ...
    @SerializedName("info")
    public Info__16 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__16 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__16 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__16 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__16 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__16 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Camille.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Camille) == false) {
            return false;
        }
        Camille rhs = ((Camille) other);
