...
public class Shyvana {
    ...
    @SerializedName("info")
    private Info__104 info;
    @SerializedName("image")
    private Image__104 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__104 stats;
    ...
    @SerializedName("info")
    public Info__104 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__104 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__104 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__104 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__104 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__104 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Shyvana.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
