...
public class Image__24 {
    ...
    public String toString() {
        ...
        sb.append(Image__24 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__24) == false) {
            return false;
        }
        Image__24 rhs = ((Image__24) other);
