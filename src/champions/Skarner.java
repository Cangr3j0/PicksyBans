...
public class Skarner {
    ...
    @SerializedName("info")
    private Info__108 info;
    @SerializedName("image")
    private Image__108 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__108 stats;
    ...
    @SerializedName("info")
    public Info__108 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__108 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__108 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__108 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__108 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__108 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Skarner.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
