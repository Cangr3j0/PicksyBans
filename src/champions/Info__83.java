...
public class Info__83 {
    ...
    public String toString() {
        ...
        sb.append(Info__83 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__83) == false) {
            return false;
        }
        Info__83 rhs = ((Info__83) other);
