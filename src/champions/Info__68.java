...
public class Info__68 {
    ...
    public String toString() {
        ...
        sb.append(Info__68 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__68) == false) {
            return false;
        }
        Info__68 rhs = ((Info__68) other);
