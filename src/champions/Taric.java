...
public class Taric {
    ...
    @SerializedName("info")
    private Info__117 info;
    @SerializedName("image")
    private Image__117 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__117 stats;
    ...
    @SerializedName("info")
    public Info__117 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__117 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__117 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__117 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__117 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__117 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Taric.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
