...
public class Kayle {
    ...
    @SerializedName("info")
    private Info__54 info;
    @SerializedName("image")
    private Image__54 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__54 stats;
    ...
    @SerializedName("info")
    public Info__54 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__54 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__54 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__54 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__54 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__54 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Kayle.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
