...
public class Akali{
    ...
    @SerializedName("stats")
    public Stats__2 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__2 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Akali.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
