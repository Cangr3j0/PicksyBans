...
public class Image__104 {
    ...
    public String toString() {
        ...
        sb.append(Image__104 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__104) == false) {
            return false;
        }
        Image__104 rhs = ((Image__104) other);
