...
public class Renekton {
    ...
    @SerializedName("info")
    private Info__94 info;
    @SerializedName("image")
    private Image__94 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__94 stats;
    ...
    @SerializedName("info")
    public Info__94 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__94 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__94 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__94 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__94 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__94 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Renekton.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
