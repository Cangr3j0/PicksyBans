...
public class Info__37 {
    ...
    public String toString() {
        ...
        sb.append(Info__37 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__37) == false) {
            return false;
        }
        Info__37 rhs = ((Info__37) other);
