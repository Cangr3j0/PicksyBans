...
public class Image__90 {
    ...
    public String toString() {
        ...
        sb.append(Image__90 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__90) == false) {
            return false;
        }
        Image__90 rhs = ((Image__90) other);
