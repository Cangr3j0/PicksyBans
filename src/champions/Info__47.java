...
public class Info__47 {
    ...
    public String toString() {
        ...
        sb.append(Info__47 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__47) == false) {
            return false;
        }
        Info__47 rhs = ((Info__47) other);
