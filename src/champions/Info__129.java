...
public class Info__129 {
    ...
    public String toString() {
        ...
        sb.append(Info__129 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__129) == false) {
            return false;
        }
        Info__129 rhs = ((Info__129) other);
