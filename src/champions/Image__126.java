...
public class Image__126 {
    ...
    public String toString() {
        ...
        sb.append(Image__126 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__126) == false) {
            return false;
        }
        Image__126 rhs = ((Image__126) other);
