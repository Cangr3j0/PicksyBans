...
public class Image__40 {
    ...
    public String toString() {
        ...
        sb.append(Image__40 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__40) == false) {
            return false;
        }
        Image__40 rhs = ((Image__40) other);
