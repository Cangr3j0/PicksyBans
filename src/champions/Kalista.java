...
public class Kalista {
    ...
    @SerializedName("info")
    private Info__49 info;
    @SerializedName("image")
    private Image__49 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__49 stats;
    ...
    @SerializedName("info")
    public Info__49 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__49 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__49 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__49 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__49 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__49 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Kalista.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
