...
public class Info__109 {
    ...
    public String toString() {
        ...
        sb.append(Info__109 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__109) == false) {
            return false;
        }
        Info__109 rhs = ((Info__109) other);
