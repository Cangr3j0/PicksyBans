...
public class Volibear {
    ...
    @SerializedName("info")
    private Info__134 info;
    @SerializedName("image")
    private Image__134 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__134 stats;
    ...
    @SerializedName("info")
    public Info__134 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__134 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__134 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__134 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__134 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__134 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Volibear.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
