...
public class Anivia {
    ...
    @SerializedName("info")
    private Info__5 info;
    @SerializedName("image")
    private Image__5 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__5 stats;
    ...
    @SerializedName("info")
    public Info__5 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__5 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__5 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__5 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__5 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__5 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Anivia.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
