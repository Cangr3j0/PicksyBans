...
public class Ivern {
    ...
    @SerializedName("info")
    private Info__41 info;
    @SerializedName("image")
    private Image__41 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__41 stats;
    ...
    @SerializedName("info")
    public Info__41 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__41 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__41 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__41 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__41 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__41 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Ivern.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ivern) == false) {
            return false;
        }
        Ivern rhs = ((Ivern) other);
