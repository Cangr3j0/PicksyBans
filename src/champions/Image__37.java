...
public class Image__37 {
    ...
    public String toString() {
        ...
        sb.append(Image__37 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__37) == false) {
            return false;
        }
        Image__37 rhs = ((Image__37) other);
