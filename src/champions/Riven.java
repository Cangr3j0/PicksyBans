...
public class Riven {
    ...
    @SerializedName("info")
    private Info__96 info;
    @SerializedName("image")
    private Image__96 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__96 stats;
    ...
    @SerializedName("info")
    public Info__96 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__96 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__96 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__96 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__96 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__96 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Riven.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
