...
public class Caitlyn {
    ...
    @SerializedName("info")
    private Info__15 info;
    @SerializedName("image")
    private Image__15 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__15 stats;
    ...
    @SerializedName("info")
    public Info__15 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__15 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__15 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__15 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__15 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__15 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Caitlyn.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
