...
public class Yorick {
    ...
    @SerializedName("info")
    private Info__140 info;
    @SerializedName("image")
    private Image__140 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__140 stats;
    ...
    @SerializedName("info")
    public Info__140 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__140 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__140 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__140 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__140 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__140 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Yorick.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
