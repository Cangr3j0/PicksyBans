...
public class Image__20 {
    ...
    public String toString() {
        ...
        sb.append(Image__20 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__20) == false) {
            return false;
        }
        Image__20 rhs = ((Image__20) other);
