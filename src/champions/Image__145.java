...
public class Image__145 {
    ...
    public String toString() {
        ...
        sb.append(Image__145 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__145) == false) {
            return false;
        }
        Image__145 rhs = ((Image__145) other);
