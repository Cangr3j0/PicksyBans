...
public class Image__113 {
    ...
    public String toString() {
        ...
        sb.append(Image__113 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__113) == false) {
            return false;
        }
        Image__113 rhs = ((Image__113) other);
