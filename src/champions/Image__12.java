...
public class Image__12 {
    ...
    public String toString() {
        ...
        sb.append(Image__12 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__12) == false) {
            return false;
        }
        Image__12 rhs = ((Image__12) other);
