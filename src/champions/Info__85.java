...
public class Info__85 {
    ...
    public String toString() {
        ...
        sb.append(Info__85 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__85) == false) {
            return false;
        }
        Info__85 rhs = ((Info__85) other);
