...
public class Info__7 {
    ...
    public String toString() {
        ...
        sb.append(Info__7 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__7) == false) {
            return false;
        }
        Info__7 rhs = ((Info__7) other);
