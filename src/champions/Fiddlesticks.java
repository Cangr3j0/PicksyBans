...
public class Fiddlesticks {
    ...
    @SerializedName("info")
    private Info__28 info;
    @SerializedName("image")
    private Image__28 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__28 stats;
    ...
    @SerializedName("info")
    public Info__28 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__28 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__28 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__28 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__28 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__28 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Fiddlesticks.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
