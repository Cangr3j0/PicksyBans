...
public class Image__60 {
    ...
    public String toString() {
        ...
        sb.append(Image__60 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__60) == false) {
            return false;
        }
        Image__60 rhs = ((Image__60) other);
