...
public class Info__130 {
    ...
    public String toString() {
        ...
        sb.append(Info__130 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__130) == false) {
            return false;
        }
        Info__130 rhs = ((Info__130) other);
