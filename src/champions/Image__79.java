...
public class Image__79 {
    ...
    public String toString() {
        ...
        sb.append(Image__79 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__79) == false) {
            return false;
        }
        Image__79 rhs = ((Image__79) other);
