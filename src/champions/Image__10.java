...
public class Image__10 {
    ...
    public String toString() {
        ...
        sb.append(Image__10 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__10) == false) {
            return false;
        }
        Image__10 rhs = ((Image__10) other);
