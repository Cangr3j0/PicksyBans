...
public class Jax {
    ...
    @SerializedName("info")
    private Info__44 info;
    @SerializedName("image")
    private Image__44 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__44 stats;
    ...
    @SerializedName("info")
    public Info__44 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__44 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__44 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__44 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__44 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__44 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Jax.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
