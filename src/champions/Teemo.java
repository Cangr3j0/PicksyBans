...
public class Teemo {
    ...
    @SerializedName("info")
    private Info__118 info;
    @SerializedName("image")
    private Image__118 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__118 stats;
    ...
    @SerializedName("info")
    public Info__118 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__118 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__118 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__118 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__118 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__118 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Teemo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
