...
public class Info__57 {
    ...
    public String toString() {
        ...
        sb.append(Info__57 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__57) == false) {
            return false;
        }
        Info__57 rhs = ((Info__57) other);
