...
public class Image__87 {
    ...
    public String toString() {
        ...
        sb.append(Image__87 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__87) == false) {
            return false;
        }
        Image__87 rhs = ((Image__87) other);
