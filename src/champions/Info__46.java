...
public class Info__46 {
    ...
    public String toString() {
        ...
        sb.append(Info__46 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__46) == false) {
            return false;
        }
        Info__46 rhs = ((Info__46) other);
