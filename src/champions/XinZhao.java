...
public class XinZhao {
    ...
    @SerializedName("info")
    private Info__138 info;
    @SerializedName("image")
    private Image__138 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__138 stats;
    ...
    @SerializedName("info")
    public Info__138 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__138 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__138 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__138 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__138 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__138 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(XinZhao.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
