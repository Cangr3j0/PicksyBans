...
public class Brand {
    ...
    @SerializedName("info")
    private Info__13 info;
    @SerializedName("image")
    private Image__13 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__13 stats;
    ...
    @SerializedName("info")
    public Info__13 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__13 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__13 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__13 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__13 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__13 stats) {
        this.stats = stats;
    }
