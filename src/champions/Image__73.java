...
public class Image__73 {
    ...
    public String toString() {
        ...
        sb.append(Image__73 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__73) == false) {
            return false;
        }
        Image__73 rhs = ((Image__73) other);
