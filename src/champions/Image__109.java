...
public class Image__109 {
    ...
    public String toString() {
        ...
        sb.append(Image__109 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__109) == false) {
            return false;
        }
        Image__109 rhs = ((Image__109) other);
