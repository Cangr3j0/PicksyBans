...
public class Image__138 {
    ...
    public String toString() {
        ...
        sb.append(Image__138 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__138) == false) {
            return false;
        }
        Image__138 rhs = ((Image__138) other);
