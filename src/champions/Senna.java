...
public class Senna {
    ...
    @SerializedName("info")
    private Info__100 info;
    @SerializedName("image")
    private Image__100 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__100 stats;
    ...
    @SerializedName("info")
    public Info__100 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__100 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__100 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__100 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__100 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__100 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Senna.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Senna) == false) {
            return false;
        }
        Senna rhs = ((Senna) other);
