...
public class Rumble {
    ...
    @SerializedName("info")
    private Info__97 info;
    @SerializedName("image")
    private Image__97 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__97 stats;
    ...
    @SerializedName("info")
    public Info__97 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__97 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__97 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__97 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__97 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__97 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Rumble.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
