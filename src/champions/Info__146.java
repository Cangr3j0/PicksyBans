...
public class Info__146 {
    ...
    public String toString() {
        ...
        sb.append(Info__146 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__146) == false) {
            return false;
        }
        Info__146 rhs = ((Info__146) other);
