...
public class Image__103 {
    ...
    public String toString() {
        ...
        sb.append(Image__103 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__103) == false) {
            return false;
        }
        Image__103 rhs = ((Image__103) other);
