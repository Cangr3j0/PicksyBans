...
public class Image__92 {
    ...
    public String toString() {
        ...
        sb.append(Image__92 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__92) == false) {
            return false;
        }
        Image__92 rhs = ((Image__92) other);
