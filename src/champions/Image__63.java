...
public class Image__63 {
    ...
    public String toString() {
        ...
        sb.append(Image__63 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__63) == false) {
            return false;
        }
        Image__63 rhs = ((Image__63) other);
