...
public class Taliyah {
    ...
    @SerializedName("info")
    private Info__115 info;
    @SerializedName("image")
    private Image__115 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__115 stats;
    ...
    @SerializedName("info")
    public Info__115 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__115 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__115 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__115 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__115 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__115 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Taliyah.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Taliyah) == false) {
            return false;
        }
        Taliyah rhs = ((Taliyah) other);
