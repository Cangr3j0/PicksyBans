...
public class Image__140 {
    ...
    public String toString() {
        ...
        sb.append(Image__140 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__140) == false) {
            return false;
        }
        Image__140 rhs = ((Image__140) other);
