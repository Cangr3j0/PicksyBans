...
public class Amumu {
    ...
    @SerializedName("info")
    private Info__4 info;
    @SerializedName("image")
    private Image__4 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__4 stats;
    ...
    @SerializedName("info")
    public Info__4 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__4 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__4 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__4 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__4 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__4 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Amumu.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
