...
public class Info__101 {
    ...
    public String toString() {
        ...
        sb.append(Info__101 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__101) == false) {
            return false;
        }
        Info__101 rhs = ((Info__101) other);
