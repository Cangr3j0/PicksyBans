...
public class Ornn {
    ...
    @SerializedName("info")
    private Info__85 info;
    @SerializedName("image")
    private Image__85 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__85 stats;
    ...
    @SerializedName("info")
    public Info__85 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__85 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__85 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__85 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__85 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__85 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Ornn.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Ornn) == false) {
            return false;
        }
        Ornn rhs = ((Ornn) other);
