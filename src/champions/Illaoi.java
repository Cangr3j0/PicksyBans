...
public class Illaoi {
    ...
    @SerializedName("info")
    private Info__39 info;
    @SerializedName("image")
    private Image__39 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__39 stats;
    ...
    @SerializedName("info")
    public Info__39 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__39 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__39 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__39 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__39 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__39 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Illaoi.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
