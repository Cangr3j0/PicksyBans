...
public class DrMundo {
    ...
    @SerializedName("info")
    private Info__23 info;
    @SerializedName("image")
    private Image__23 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__23 stats;
    ...
    @SerializedName("info")
    public Info__23 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__23 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__23 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__23 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__23 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__23 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(DrMundo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
