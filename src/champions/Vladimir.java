...
public class Vladimir {
    ...
    @SerializedName("info")
    private Info__133 info;
    @SerializedName("image")
    private Image__133 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__133 stats;
    ...
    @SerializedName("info")
    public Info__133 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__133 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__133 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__133 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__133 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__133 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Vladimir.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
