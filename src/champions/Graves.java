...
public class Graves {
    ...
    @SerializedName("info")
    private Info__36 info;
    @SerializedName("image")
    private Image__36 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__36 stats;
    ...
    @SerializedName("info")
    public Info__36 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__36 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__36 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__36 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__36 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__36 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Graves.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
