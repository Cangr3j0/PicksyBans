...
public class Galio {
    ...
    @SerializedName("info")
    private Info__31 info;
    @SerializedName("image")
    private Image__31 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__31 stats;
    ...
    @SerializedName("info")
    public Info__31 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__31 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__31 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__31 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__31 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__31 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Galio.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
