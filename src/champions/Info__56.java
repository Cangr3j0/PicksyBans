...
public class Info__56 {
    ...
    public String toString() {
        ...
        sb.append(Info__56 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__56) == false) {
            return false;
        }
        Info__56 rhs = ((Info__56) other);
