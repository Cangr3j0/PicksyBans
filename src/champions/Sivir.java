...
public class Sivir {
    ...
    @SerializedName("info")
    private Info__107 info;
    @SerializedName("image")
    private Image__107 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__107 stats;
    ...
    @SerializedName("info")
    public Info__107 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__107 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__107 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__107 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__107 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__107 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Sivir.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
