...
public class TahmKench {
    ...
    @SerializedName("info")
    private Info__114 info;
    @SerializedName("image")
    private Image__114 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__114 stats;
    ...
    @SerializedName("info")
    public Info__114 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__114 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__114 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__114 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__114 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__114 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(TahmKench.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
