...
public class Image__135 {
    ...
    public String toString() {
        ...
        sb.append(Image__135 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__135) == false) {
            return false;
        }
        Image__135 rhs = ((Image__135) other);
