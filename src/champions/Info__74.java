...
public class Info__74 {
    ...
    public String toString() {
        ...
        sb.append(Info__74 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__74) == false) {
            return false;
        }
        Info__74 rhs = ((Info__74) other);
