...
public class Ezreal {
    ...
    @SerializedName("info")
    private Info__27 info;
    @SerializedName("image")
    private Image__27 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__27 stats;
    ...
    @SerializedName("info")
    public Info__27 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__27 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__27 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__27 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__27 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__27 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Ezreal.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
