...
public class Info__114 {
    ...
    public String toString() {
        ...
        sb.append(Info__114 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__114) == false) {
            return false;
        }
        Info__114 rhs = ((Info__114) other);
