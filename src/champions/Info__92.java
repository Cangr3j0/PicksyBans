...
public class Info__92 {
    ...
    public String toString() {
        ...
        sb.append(Info__92 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__92) == false) {
            return false;
        }
        Info__92 rhs = ((Info__92) other);
