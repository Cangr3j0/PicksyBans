...
public class Image__136 {
    ...
    public String toString() {
        ...
        sb.append(Image__136 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__136) == false) {
            return false;
        }
        Image__136 rhs = ((Image__136) other);
