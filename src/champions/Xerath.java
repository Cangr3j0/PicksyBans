...
public class Xerath {
    ...
    @SerializedName("info")
    private Info__137 info;
    @SerializedName("image")
    private Image__137 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__137 stats;
    ...
    @SerializedName("info")
    public Info__137 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__137 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__137 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__137 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__137 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__137 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Xerath.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
