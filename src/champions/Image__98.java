...
public class Image__98 {
    ...
    public String toString() {
        ...
        sb.append(Image__98 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__98) == false) {
            return false;
        }
        Image__98 rhs = ((Image__98) other);
