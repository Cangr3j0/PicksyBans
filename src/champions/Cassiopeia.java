...
public class Cassiopeia {
    ...
    @SerializedName("info")
    private Info__17 info;
    @SerializedName("image")
    private Image__17 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__17 stats;
    ...
    @SerializedName("info")
    public Info__17 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__17 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__17 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__17 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__17 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__17 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Cassiopeia.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
