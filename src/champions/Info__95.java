...
public class Info__95 {
    ...
    public String toString() {
        ...
        sb.append(Info__95 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__95) == false) {
            return false;
        }
        Info__95 rhs = ((Info__95) other);
