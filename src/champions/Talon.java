...
public class Talon {
    ...
    @SerializedName("info")
    private Info__116 info;
    @SerializedName("image")
    private Image__116 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__116 stats;
    ...
    @SerializedName("info")
    public Info__116 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__116 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__116 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__116 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__116 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__116 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Talon.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
