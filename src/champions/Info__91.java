...
public class Info__91 {
    ...
    public String toString() {
        ...
        sb.append(Info__91 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__91) == false) {
            return false;
        }
        Info__91 rhs = ((Info__91) other);
