...
public class Image__128 {
    ...
    public String toString() {
        ...
        sb.append(Image__128 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__128) == false) {
            return false;
        }
        Image__128 rhs = ((Image__128) other);
