...
public class Image__31 {
    ...
    public String toString() {
        ...
        sb.append(Image__31 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__31) == false) {
            return false;
        }
        Image__31 rhs = ((Image__31) other);
