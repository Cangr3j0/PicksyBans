...
public class Info__34 {
    ...
    public String toString() {
        ...
        sb.append(Info__34 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__34) == false) {
            return false;
        }
        Info__34 rhs = ((Info__34) other);
