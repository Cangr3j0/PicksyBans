...
public class Info__140 {
    ...
    public String toString() {
        ...
        sb.append(Info__140 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__140) == false) {
            return false;
        }
        Info__140 rhs = ((Info__140) other);
