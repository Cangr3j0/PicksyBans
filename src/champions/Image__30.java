...
public class Image__30 {
    ...
    public String toString() {
        ...
        sb.append(Image__30 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__30) == false) {
            return false;
        }
        Image__30 rhs = ((Image__30) other);
