...
public class Image__71 {
    ...
    public String toString() {
        ...
        sb.append(Image__71 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__71) == false) {
            return false;
        }
        Image__71 rhs = ((Image__71) other);
