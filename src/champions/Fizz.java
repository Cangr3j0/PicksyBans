...
public class Fizz {
    ...
    @SerializedName("info")
    private Info__30 info;
    @SerializedName("image")
    private Image__30 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__30 stats;
    ...
    @SerializedName("info")
    public Info__30 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__30 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__30 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__30 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__30 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__30 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Fizz.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
