...
public class Image__16 {
    ...
    public String toString() {
        ...
        sb.append(Image__16 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__16) == false) {
            return false;
        }
        Image__16 rhs = ((Image__16) other);
