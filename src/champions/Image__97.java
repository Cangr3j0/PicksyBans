...
public class Image__97 {
    ...
    public String toString() {
        ...
        sb.append(Image__97 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__97) == false) {
            return false;
        }
        Image__97 rhs = ((Image__97) other);
