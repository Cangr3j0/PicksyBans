...
public class Image__88 {
    ...
    public String toString() {
        ...
        sb.append(Image__88 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__88) == false) {
            return false;
        }
        Image__88 rhs = ((Image__88) other);
