...
public class Image__131 {
    ...
    public String toString() {
        ...
        sb.append(Image__131 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__131) == false) {
            return false;
        }
        Image__131 rhs = ((Image__131) other);
