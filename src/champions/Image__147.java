...
public class Image__147 {
    ...
    public String toString() {
        ...
        sb.append(Image__147 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__147) == false) {
            return false;
        }
        Image__147 rhs = ((Image__147) other);
