...
public class Image__85 {
    ...
    public String toString() {
        ...
        sb.append(Image__85 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__85) == false) {
            return false;
        }
        Image__85 rhs = ((Image__85) other);
