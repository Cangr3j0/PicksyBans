...
public class Info__115 {
    ...
    public String toString() {
        ...
        sb.append(Info__115 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__115) == false) {
            return false;
        }
        Info__115 rhs = ((Info__115) other);
