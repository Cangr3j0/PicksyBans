...
public class Image__111 {
    ...
    public String toString() {
        ...
        sb.append(Image__111 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__111) == false) {
            return false;
        }
        Image__111 rhs = ((Image__111) other);
