...
public class Yuumi {
    ...
    @SerializedName("info")
    private Info__141 info;
    @SerializedName("image")
    private Image__141 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__141 stats;
    ...
    @SerializedName("info")
    public Info__141 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__141 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__141 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__141 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__141 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__141 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Yuumi.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Yuumi) == false) {
            return false;
        }
        Yuumi rhs = ((Yuumi) other);
