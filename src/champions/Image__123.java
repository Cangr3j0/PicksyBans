...
public class Image__123 {
    ...
    public String toString() {
        ...
        sb.append(Image__123 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__123) == false) {
            return false;
        }
        Image__123 rhs = ((Image__123) other);
