...
public class TwistedFate {
    ...
    @SerializedName("info")
    private Info__123 info;
    @SerializedName("image")
    private Image__123 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__123 stats;
    ...
    @SerializedName("info")
    public Info__123 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__123 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__123 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__123 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__123 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__123 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(TwistedFate.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
