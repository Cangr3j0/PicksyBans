...
public class Image__22 {
    ...
    public String toString() {
        ...
        sb.append(Image__22 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__22) == false) {
            return false;
        }
        Image__22 rhs = ((Image__22) other);
