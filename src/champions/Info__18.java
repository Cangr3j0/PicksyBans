...
public class Info__18 {
    ...
    public String toString() {
        ...
        sb.append(Info__18 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__18) == false) {
            return false;
        }
        Info__18 rhs = ((Info__18) other);
