...
public class Image__68 {
    ...
    public String toString() {
        ...
        sb.append(Image__68 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__68) == false) {
            return false;
        }
        Image__68 rhs = ((Image__68) other);
