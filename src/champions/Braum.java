...
public class Braum {
    ...
    @SerializedName("info")
    private Info__14 info;
    @SerializedName("image")
    private Image__14 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__14 stats;
    ...
    @SerializedName("info")
    public Info__14 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__14 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__14 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__14 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__14 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__14 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Braum.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
