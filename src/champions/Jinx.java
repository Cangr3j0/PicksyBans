...
public class Jinx {
    ...
    @SerializedName("info")
    private Info__47 info;
    @SerializedName("image")
    private Image__47 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__47 stats;
    ...
    @SerializedName("info")
    public Info__47 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__47 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__47 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__47 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__47 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__47 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Jinx.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
