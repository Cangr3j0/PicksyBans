...
public class Info__65 {
    ...
    public String toString() {
        ...
        sb.append(Info__65 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__65) == false) {
            return false;
        }
        Info__65 rhs = ((Info__65) other);
