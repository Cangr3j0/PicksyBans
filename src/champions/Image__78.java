...
public class Image__78 {
    ...
    public String toString() {
        ...
        sb.append(Image__78 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__78) == false) {
            return false;
        }
        Image__78 rhs = ((Image__78) other);
