...
public class Hecarim {
    ...
    @SerializedName("info")
    private Info__37 info;
    @SerializedName("image")
    private Image__37 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__37 stats;
    ...
    @SerializedName("info")
    public Info__37 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__37 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__37 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__37 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__37 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__37 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Hecarim.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
