...
public class Nautilus {
    ...
    @SerializedName("info")
    private Info__78 info;
    @SerializedName("image")
    private Image__78 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__78 stats;
    ...
    @SerializedName("info")
    public Info__78 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__78 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__78 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__78 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__78 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__78 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Nautilus.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
