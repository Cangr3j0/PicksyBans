...
public class Info__66 {
    ...
    public String toString() {
        ...
        sb.append(Info__66 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__66) == false) {
            return false;
        }
        Info__66 rhs = ((Info__66) other);
