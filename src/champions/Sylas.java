...
public class Sylas {
    ...
    @SerializedName("info")
    private Info__112 info;
    @SerializedName("image")
    private Image__112 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__112 stats;
    ...
    @SerializedName("info")
    public Info__112 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__112 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__112 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__112 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__112 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__112 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Sylas.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sylas) == false) {
            return false;
        }
        Sylas rhs = ((Sylas) other);
