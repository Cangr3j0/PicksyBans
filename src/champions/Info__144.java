...
public class Info__144 {
    ...
    public String toString() {
        ...
        sb.append(Info__144 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__144) == false) {
            return false;
        }
        Info__144 rhs = ((Info__144) other);
