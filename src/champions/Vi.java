...
public class Vi {
    ...
    @SerializedName("info")
    private Info__131 info;
    @SerializedName("image")
    private Image__131 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__131 stats;
    ...
    @SerializedName("info")
    public Info__131 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__131 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__131 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__131 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__131 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__131 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Vi.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
