...
public class Poppy {
    ...
    @SerializedName("info")
    private Info__87 info;
    @SerializedName("image")
    private Image__87 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__87 stats;
    ...
    @SerializedName("info")
    public Info__87 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__87 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__87 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__87 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__87 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__87 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Poppy.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
