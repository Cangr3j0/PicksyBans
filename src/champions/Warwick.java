...
public class Warwick {
    ...
    @SerializedName("info")
    private Info__135 info;
    @SerializedName("image")
    private Image__135 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__135 stats;
    ...
    @SerializedName("info")
    public Info__135 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__135 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__135 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__135 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__135 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__135 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Warwick.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
