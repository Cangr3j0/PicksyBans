...
public class Info__125 {
    ...
    public String toString() {
        ...
        sb.append(Info__125 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__125) == false) {
            return false;
        }
        Info__125 rhs = ((Info__125) other);
