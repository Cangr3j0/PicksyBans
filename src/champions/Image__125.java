...
public class Image__125 {
    ...
    public String toString() {
        ...
        sb.append(Image__125 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__125) == false) {
            return false;
        }
        Image__125 rhs = ((Image__125) other);
