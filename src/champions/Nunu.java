...
public class Nunu {
    ...
    @SerializedName("info")
    private Info__82 info;
    @SerializedName("image")
    private Image__82 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__82 stats;
    ...
    @SerializedName("info")
    public Info__82 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__82 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__82 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__82 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__82 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__82 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Nunu.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
