...
public class Gragas {
    ...
    @SerializedName("info")
    private Info__35 info;
    @SerializedName("image")
    private Image__35 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__35 stats;
    ...
    @SerializedName("info")
    public Info__35 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__35 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__35 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__35 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__35 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__35 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Gragas.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
