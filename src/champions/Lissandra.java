...
public class Lissandra {
    ...
    @SerializedName("info")
    private Info__64 info;
    @SerializedName("image")
    private Image__64 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__64 stats;
    ...
    @SerializedName("info")
    public Info__64 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__64 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__64 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__64 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__64 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__64 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Lissandra.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
