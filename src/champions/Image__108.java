...
public class Image__108 {
    ...
    public String toString() {
        ...
        sb.append(Image__108 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__108) == false) {
            return false;
        }
        Image__108 rhs = ((Image__108) other);
