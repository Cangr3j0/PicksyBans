...
public class Info__12 {
    ...
    public String toString() {
        ...
        sb.append(Info__12 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__12) == false) {
            return false;
        }
        Info__12 rhs = ((Info__12) other);
