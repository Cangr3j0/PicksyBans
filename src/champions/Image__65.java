...
public class Image__65 {
    ...
    public String toString() {
        ...
        sb.append(Image__65 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__65) == false) {
            return false;
        }
        Image__65 rhs = ((Image__65) other);
