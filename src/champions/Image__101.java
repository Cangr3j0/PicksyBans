...
public class Image__101 {
    ...
    public String toString() {
        ...
        sb.append(Image__101 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__101) == false) {
            return false;
        }
        Image__101 rhs = ((Image__101) other);
