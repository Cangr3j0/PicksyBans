...
public class Xayah {
    ...
    @SerializedName("info")
    private Info__136 info;
    @SerializedName("image")
    private Image__136 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__136 stats;
    ...
    @SerializedName("info")
    public Info__136 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__136 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__136 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__136 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__136 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__136 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Xayah.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Xayah) == false) {
            return false;
        }
        Xayah rhs = ((Xayah) other);
