...
public class Info__69 {
    ...
    public String toString() {
        ...
        sb.append(Info__69 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__69) == false) {
            return false;
        }
        Info__69 rhs = ((Info__69) other);
