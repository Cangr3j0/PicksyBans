...
public class Image__58 {
    ...
    public String toString() {
        ...
        sb.append(Image__58 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__58) == false) {
            return false;
        }
        Image__58 rhs = ((Image__58) other);
