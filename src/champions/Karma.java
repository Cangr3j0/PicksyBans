...
public class Karma {
    ...
    @SerializedName("info")
    private Info__50 info;
    @SerializedName("image")
    private Image__50 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__50 stats;
    ...
    @SerializedName("info")
    public Info__50 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__50 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__50 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__50 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__50 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__50 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Karma.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
