...
public class Qiyana {
    ...
    @SerializedName("info")
    private Info__89 info;
    @SerializedName("image")
    private Image__89 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__89 stats;
    ...
    @SerializedName("info")
    public Info__89 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__89 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__89 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__89 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__89 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__89 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Qiyana.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Qiyana) == false) {
            return false;
        }
        Qiyana rhs = ((Qiyana) other);
