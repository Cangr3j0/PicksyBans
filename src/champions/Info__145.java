...
public class Info__145 {
    ...
    public String toString() {
        ...
        sb.append(Info__145 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__145) == false) {
            return false;
        }
        Info__145 rhs = ((Info__145) other);
