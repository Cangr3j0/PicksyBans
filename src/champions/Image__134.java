...
public class Image__134 {
    ...
    public String toString() {
        ...
        sb.append(Image__134 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__134) == false) {
            return false;
        }
        Image__134 rhs = ((Image__134) other);
