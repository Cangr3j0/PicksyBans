...
public class Info__131 {
    ...
    public String toString() {
        ...
        sb.append(Info__131 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__131) == false) {
            return false;
        }
        Info__131 rhs = ((Info__131) other);
