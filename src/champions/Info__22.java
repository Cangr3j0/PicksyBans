...
public class Info__22 {
    ...
    public String toString() {
        ...
        sb.append(Info__22 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__22) == false) {
            return false;
        }
        Info__22 rhs = ((Info__22) other);
