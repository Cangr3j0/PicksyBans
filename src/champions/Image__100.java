...
public class Image__100 {
    ...
    public String toString() {
        ...
        sb.append(Image__100 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__100) == false) {
            return false;
        }
        Image__100 rhs = ((Image__100) other);
