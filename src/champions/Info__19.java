...
public class Info__19 {
    ...
    public String toString() {
        ...
        sb.append(Info__19 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__19) == false) {
            return false;
        }
        Info__19 rhs = ((Info__19) other);
