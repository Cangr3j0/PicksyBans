...
public class Image__107 {
    ...
    public String toString() {
        ...
        sb.append(Image__107 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__107) == false) {
            return false;
        }
        Image__107 rhs = ((Image__107) other);
