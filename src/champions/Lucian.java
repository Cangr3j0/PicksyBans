...
public class Lucian {
    ...
    @SerializedName("info")
    private Info__65 info;
    @SerializedName("image")
    private Image__65 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__65 stats;
    ...
    @SerializedName("info")
    public Info__65 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__65 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__65 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__65 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__65 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__65 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Lucian.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
