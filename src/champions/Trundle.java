...
public class Trundle {
    ...
    @SerializedName("info")
    private Info__121 info;
    @SerializedName("image")
    private Image__121 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__121 stats;
    ...
    @SerializedName("info")
    public Info__121 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__121 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__121 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__121 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__121 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__121 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Trundle.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
