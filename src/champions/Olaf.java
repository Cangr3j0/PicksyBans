...
public class Olaf {
    ...
    @SerializedName("info")
    private Info__83 info;
    @SerializedName("image")
    private Image__83 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__83 stats;
    ...
    @SerializedName("info")
    public Info__83 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__83 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__83 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__83 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__83 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__83 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Olaf.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
