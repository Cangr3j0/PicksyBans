...
public class Image__5 {
    ...
    public String toString() {
        ...
        sb.append(Image__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__5) == false) {
            return false;
        }
        Image__5 rhs = ((Image__5) other);
