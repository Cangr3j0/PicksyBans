...
public class Chogath {
    ...
    @SerializedName("info")
    private Info__18 info;
    @SerializedName("image")
    private Image__18 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__18 stats;
    ...
    @SerializedName("info")
    public Info__18 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__18 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__18 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__18 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__18 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__18 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Chogath.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
