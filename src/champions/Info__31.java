...
public class Info__31 {
    ...
    public String toString() {
        ...
        sb.append(Info__31 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__31) == false) {
            return false;
        }
        Info__31 rhs = ((Info__31) other);
