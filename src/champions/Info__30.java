...
public class Info__30 {
    ...
    public String toString() {
        ...
        sb.append(Info__30 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__30) == false) {
            return false;
        }
        Info__30 rhs = ((Info__30) other);
