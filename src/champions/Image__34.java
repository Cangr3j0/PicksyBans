...
public class Image__34 {
    ...
    public String toString() {
        ...
        sb.append(Image__34 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__34) == false) {
            return false;
        }
        Image__34 rhs = ((Image__34) other);
