...
public class Kindred {
    ...
    @SerializedName("info")
    private Info__58 info;
    @SerializedName("image")
    private Image__58 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__58 stats;
    ...
    @SerializedName("info")
    public Info__58 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__58 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__58 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__58 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__58 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__58 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Kindred.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
