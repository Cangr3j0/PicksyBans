...
public class Leblanc {
    ...
    @SerializedName("info")
    private Info__61 info;
    @SerializedName("image")
    private Image__61 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__61 stats;
    ...
    @SerializedName("info")
    public Info__61 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__61 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__61 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__61 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__61 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__61 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Leblanc.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
