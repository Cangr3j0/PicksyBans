...
public class Quinn {
    ...
    @SerializedName("info")
    private Info__90 info;
    @SerializedName("image")
    private Image__90 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__90 stats;
    ...
    @SerializedName("info")
    public Info__90 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__90 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__90 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__90 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__90 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__90 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Quinn.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
