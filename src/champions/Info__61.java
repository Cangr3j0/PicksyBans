...
public class Info__61 {
    ...
    public String toString() {
        ...
        sb.append(Info__61 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__61) == false) {
            return false;
        }
        Info__61 rhs = ((Info__61) other);
