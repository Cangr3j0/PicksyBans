...
public class Varus {
    ...
    @SerializedName("info")
    private Info__127 info;
    @SerializedName("image")
    private Image__127 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__127 stats;
    ...
    @SerializedName("info")
    public Info__127 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__127 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__127 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__127 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__127 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__127 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Varus.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
