...
public class Garen {
    ...
    @SerializedName("info")
    private Info__33 info;
    @SerializedName("image")
    private Image__33 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__33 stats;
    ...
    @SerializedName("info")
    public Info__33 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__33 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__33 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__33 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__33 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__33 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Garen.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
