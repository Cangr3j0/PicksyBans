...
public class Info__124 {
    ...
    public String toString() {
        ...
        sb.append(Info__124 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__124) == false) {
            return false;
        }
        Info__124 rhs = ((Info__124) other);
