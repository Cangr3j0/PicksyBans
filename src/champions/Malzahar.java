...
public class Malzahar {
    ...
    @SerializedName("info")
    private Info__69 info;
    @SerializedName("image")
    private Image__69 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__69 stats;
    ...
    @SerializedName("info")
    public Info__69 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__69 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__69 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__69 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__69 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__69 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Malzahar.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
