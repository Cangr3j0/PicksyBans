...
public class Info__67 {
    ...
    public String toString() {
        ...
        sb.append(Info__67 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__67) == false) {
            return false;
        }
        Info__67 rhs = ((Info__67) other);
