...
public class Draven {
    ...
    @SerializedName("info")
    private Info__22 info;
    @SerializedName("image")
    private Image__22 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__22 stats;
    ...
    @SerializedName("info")
    public Info__22 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__22 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__22 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__22 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__22 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__22 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Draven.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
