...
public class Image__77 {
    ...
    public String toString() {
        ...
        sb.append(Image__77 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__77) == false) {
            return false;
        }
        Image__77 rhs = ((Image__77) other);
