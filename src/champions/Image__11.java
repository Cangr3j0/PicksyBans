...
public class Image__11 {
    ...
    public String toString() {
        ...
        sb.append(Image__11 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__11) == false) {
            return false;
        }
        Image__11 rhs = ((Image__11) other);
