...
public class Info__142 {
    ...
    public String toString() {
        ...
        sb.append(Info__142 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__142) == false) {
            return false;
        }
        Info__142 rhs = ((Info__142) other);
