...
public class Pyke {
    ...
    @SerializedName("info")
    private Info__88 info;
    @SerializedName("image")
    private Image__88 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__88 stats;
    ...
    @SerializedName("info")
    public Info__88 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__88 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__88 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__88 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__88 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__88 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Pyke.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Pyke) == false) {
            return false;
        }
        Pyke rhs = ((Pyke) other);
