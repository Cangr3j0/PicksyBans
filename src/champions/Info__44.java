...
public class Info__44 {
    ...
    public String toString() {
        ...
        sb.append(Info__44 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__44) == false) {
            return false;
        }
        Info__44 rhs = ((Info__44) other);
