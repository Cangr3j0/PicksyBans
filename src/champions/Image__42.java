...
public class Image__42 {
    ...
    public String toString() {
        ...
        sb.append(Image__42 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__42) == false) {
            return false;
        }
        Image__42 rhs = ((Image__42) other);
