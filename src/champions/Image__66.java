...
public class Image__66 {
    ...
    public String toString() {
        ...
        sb.append(Image__66 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__66) == false) {
            return false;
        }
        Image__66 rhs = ((Image__66) other);
