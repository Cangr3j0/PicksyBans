...
public class Info__9 {
    ...
    public String toString() {
        ...
        sb.append(Info__9 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__9) == false) {
            return false;
        }
        Info__9 rhs = ((Info__9) other);
