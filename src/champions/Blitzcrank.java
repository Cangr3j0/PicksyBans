...
public class Blitzcrank {
    ...
    @SerializedName("info")
    private Info__12 info;
    @SerializedName("image")
    private Image__12 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__12 stats;
    ...
    @SerializedName("info")
    public Info__12 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__12 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__12 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__12 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__12 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__12 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Blitzcrank.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
