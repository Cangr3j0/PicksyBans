...
public class Info__20 {
    ...
    public String toString() {
        ...
        sb.append(Info__20 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__20) == false) {
            return false;
        }
        Info__20 rhs = ((Info__20) other);
