...
public class Image__7 {
    ...
    public String toString() {
        ...
        sb.append(Image__7 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__7) == false) {
            return false;
        }
        Image__7 rhs = ((Image__7) other);
