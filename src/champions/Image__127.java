...
public class Image__127 {
    ...
    public String toString() {
        ...
        sb.append(Image__127 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__127) == false) {
            return false;
        }
        Image__127 rhs = ((Image__127) other);
