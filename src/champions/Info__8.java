...
public class Info__8 {
    ...
    public String toString() {
        ...
        sb.append(Info__8 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__8) == false) {
            return false;
        }
        Info__8 rhs = ((Info__8) other);
