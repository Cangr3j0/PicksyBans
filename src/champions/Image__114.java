...
public class Image__114 {
    ...
    public String toString() {
        ...
        sb.append(Image__114 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__114) == false) {
            return false;
        }
        Image__114 rhs = ((Image__114) other);
