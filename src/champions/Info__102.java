...
public class Info__102 {
    ...
    public String toString() {
        ...
        sb.append(Info__102 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__102) == false) {
            return false;
        }
        Info__102 rhs = ((Info__102) other);
