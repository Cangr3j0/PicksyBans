...
public class Info__141 {
    ...
    public String toString() {
        ...
        sb.append(Info__141 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__141) == false) {
            return false;
        }
        Info__141 rhs = ((Info__141) other);
