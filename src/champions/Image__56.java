...
public class Image__56 {
    ...
    public String toString() {
        ...
        sb.append(Image__56 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__56) == false) {
            return false;
        }
        Image__56 rhs = ((Image__56) other);
