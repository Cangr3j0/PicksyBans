...
public class Image__82 {
    ...
    public String toString() {
        ...
        sb.append(Image__82 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__82) == false) {
            return false;
        }
        Image__82 rhs = ((Image__82) other);
