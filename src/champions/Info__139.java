...
public class Info__139 {
    ...
    public String toString() {
        ...
        sb.append(Info__139 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__139) == false) {
            return false;
        }
        Info__139 rhs = ((Info__139) other);
