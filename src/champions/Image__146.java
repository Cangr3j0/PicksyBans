...
public class Image__146 {
    ...
    public String toString() {
        ...
        sb.append(Image__146 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__146) == false) {
            return false;
        }
        Image__146 rhs = ((Image__146) other);
