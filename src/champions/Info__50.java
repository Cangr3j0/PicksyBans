...
public class Info__50 {
    ...
    public String toString() {
        ...
        sb.append(Info__50 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__50) == false) {
            return false;
        }
        Info__50 rhs = ((Info__50) other);
