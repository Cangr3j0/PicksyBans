...
public class Image__144 {
    ...
    public String toString() {
        ...
        sb.append(Image__144 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__144) == false) {
            return false;
        }
        Image__144 rhs = ((Image__144) other);
