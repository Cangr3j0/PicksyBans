...
public class Heimerdinger {
    ...
    @SerializedName("info")
    private Info__38 info;
    @SerializedName("image")
    private Image__38 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__38 stats;
    ...
    @SerializedName("info")
    public Info__38 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__38 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__38 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__38 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__38 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__38 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Heimerdinger.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
