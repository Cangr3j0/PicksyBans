...
public class Image__25 {
    ...
    public String toString() {
        ...
        sb.append(Image__25 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__25) == false) {
            return false;
        }
        Image__25 rhs = ((Image__25) other);
