...
public class Info__36 {
    ...
    public String toString() {
        ...
        sb.append(Info__36 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__36) == false) {
            return false;
        }
        Info__36 rhs = ((Info__36) other);
