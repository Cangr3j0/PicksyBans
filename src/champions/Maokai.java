...
public class Maokai {
    ...
    @SerializedName("info")
    private Info__70 info;
    @SerializedName("image")
    private Image__70 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__70 stats;
    ...
    @SerializedName("info")
    public Info__70 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__70 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__70 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__70 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__70 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__70 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Maokai.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
