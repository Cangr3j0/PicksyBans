...
public class Info__3 {
    ...
    public String toString() {
        ...
        sb.append(Info__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__3) == false) {
            return false;
        }
        Info__3 rhs = ((Info__3) other);
