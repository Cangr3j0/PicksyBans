...
public class Karthus {
    ...
    @SerializedName("info")
    private Info__51 info;
    @SerializedName("image")
    private Image__51 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__51 stats;
    ...
    @SerializedName("info")
    public Info__51 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__51 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__51 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__51 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__51 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__51 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Karthus.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
