...
public class Kaisa {
    ...
    @SerializedName("info")
    private Info__48 info;
    @SerializedName("image")
    private Image__48 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__48 stats;
    ...
    @SerializedName("info")
    public Info__48 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__48 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__48 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__48 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__48 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__48 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Kaisa.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Kaisa) == false) {
            return false;
        }
        Kaisa rhs = ((Kaisa) other);
