...
public class Vayne {
    ...
    @SerializedName("info")
    private Info__128 info;
    @SerializedName("image")
    private Image__128 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__128 stats;
    ...
    @SerializedName("info")
    public Info__128 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__128 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__128 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__128 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__128 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__128 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Vayne.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
