...
public class Alistar {
    ...
    @SerializedName("info")
    private Info__3 info;
    @SerializedName("image")
    private Image__3 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__3 stats;
    ...
    @SerializedName("info")
    public Info__3 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__3 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__3 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__3 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__3 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__3 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Alistar.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
