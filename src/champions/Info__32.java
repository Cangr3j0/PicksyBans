...
public class Info__32 {
    ...
    public String toString() {
        ...
        sb.append(Info__32 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__32) == false) {
            return false;
        }
        Info__32 rhs = ((Info__32) other);
