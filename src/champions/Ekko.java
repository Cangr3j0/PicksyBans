...
public class Ekko {
    ...
    @SerializedName("info")
    private Info__24 info;
    @SerializedName("image")
    private Image__24 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__24 stats;
    ...
    @SerializedName("info")
    public Info__24 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__24 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__24 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__24 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__24 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__24 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Ekko.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
