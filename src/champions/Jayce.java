...
public class Jayce {
    ...
    @SerializedName("info")
    private Info__45 info;
    @SerializedName("image")
    private Image__45 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__45 stats;
    ...
    @SerializedName("info")
    public Info__45 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__45 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__45 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__45 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__45 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__45 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Jayce.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
