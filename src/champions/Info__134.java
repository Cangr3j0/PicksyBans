...
public class Info__134 {
    ...
    public String toString() {
        ...
        sb.append(Info__134 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__134) == false) {
            return false;
        }
        Info__134 rhs = ((Info__134) other);
