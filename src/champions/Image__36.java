...
public class Image__36 {
    ...
    public String toString() {
        ...
        sb.append(Image__36 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__36) == false) {
            return false;
        }
        Image__36 rhs = ((Image__36) other);
