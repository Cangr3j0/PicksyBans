...
public class Syndra {
    ...
    @SerializedName("info")
    private Info__113 info;
    @SerializedName("image")
    private Image__113 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__113 stats;
    ...
    @SerializedName("info")
    public Info__113 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__113 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__113 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__113 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__113 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__113 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Syndra.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
