...
public class Image__14 {
    ...
    public String toString() {
        ...
        sb.append(Image__14 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__14) == false) {
            return false;
        }
        Image__14 rhs = ((Image__14) other);
