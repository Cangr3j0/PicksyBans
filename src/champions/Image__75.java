...
public class Image__75 {
    ...
    public String toString() {
        ...
        sb.append(Image__75 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__75) == false) {
            return false;
        }
        Image__75 rhs = ((Image__75) other);
