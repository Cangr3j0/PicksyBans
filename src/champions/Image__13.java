...
public class Image__13 {
    ...
    public String toString() {
        ...
        sb.append(Image__13 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__13) == false) {
            return false;
        }
        Image__13 rhs = ((Image__13) other);
