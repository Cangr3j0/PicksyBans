...
public class Info__143 {
    ...
    public String toString() {
        ...
        sb.append(Info__143 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__143) == false) {
            return false;
        }
        Info__143 rhs = ((Info__143) other);
