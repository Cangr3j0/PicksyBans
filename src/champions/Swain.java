...
public class Swain {
    ...
    @SerializedName("info")
    private Info__111 info;
    @SerializedName("image")
    private Image__111 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__111 stats;
    ...
    @SerializedName("info")
    public Info__111 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__111 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__111 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__111 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__111 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__111 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Swain.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
