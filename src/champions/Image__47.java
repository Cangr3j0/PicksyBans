...
public class Image__47 {
    ...
    public String toString() {
        ...
        sb.append(Image__47 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__47) == false) {
            return false;
        }
        Image__47 rhs = ((Image__47) other);
