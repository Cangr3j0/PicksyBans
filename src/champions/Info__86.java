...
public class Info__86 {
    ...
    public String toString() {
        ...
        sb.append(Info__86 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__86) == false) {
            return false;
        }
        Info__86 rhs = ((Info__86) other);
