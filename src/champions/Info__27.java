...
public class Info__27 {
    ...
    public String toString() {
        ...
        sb.append(Info__27 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__27) == false) {
            return false;
        }
        Info__27 rhs = ((Info__27) other);
