...
public class Info__5 {
    ...
    public String toString() {
        ...
        sb.append(Info__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__5) == false) {
            return false;
        }
        Info__5 rhs = ((Info__5) other);
