...
public class Image__106 {
    ...
    public String toString() {
        ...
        sb.append(Image__106 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__106) == false) {
            return false;
        }
        Image__106 rhs = ((Image__106) other);
