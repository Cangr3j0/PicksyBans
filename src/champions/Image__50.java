...
public class Image__50 {
    ...
    public String toString() {
        ...
        sb.append(Image__50 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__50) == false) {
            return false;
        }
        Image__50 rhs = ((Image__50) other);
