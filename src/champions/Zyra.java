...
public class Zyra {
    ...
    @SerializedName("info")
    private Info__147 info;
    @SerializedName("image")
    private Image__147 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__147 stats;
    ...
    @SerializedName("info")
    public Info__147 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__147 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__147 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__147 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__147 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__147 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Zyra.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
