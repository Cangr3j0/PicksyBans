...
public class Info__52 {
    ...
    public String toString() {
        ...
        sb.append(Info__52 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__52) == false) {
            return false;
        }
        Info__52 rhs = ((Info__52) other);
