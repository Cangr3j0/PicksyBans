...
public class Info__28 {
    ...
    public String toString() {
        ...
        sb.append(Info__28 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__28) == false) {
            return false;
        }
        Info__28 rhs = ((Info__28) other);
