...
public class Info__107 {
    ...
    public String toString() {
        ...
        sb.append(Info__107 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__107) == false) {
            return false;
        }
        Info__107 rhs = ((Info__107) other);
