...
public class Image__49 {
    ...
    public String toString() {
        ...
        sb.append(Image__49 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__49) == false) {
            return false;
        }
        Image__49 rhs = ((Image__49) other);
