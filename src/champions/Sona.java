...
public class Sona {
    ...
    @SerializedName("info")
    private Info__109 info;
    @SerializedName("image")
    private Image__109 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__109 stats;
    ...
    @SerializedName("info")
    public Info__109 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__109 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__109 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__109 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__109 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__109 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Sona.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
