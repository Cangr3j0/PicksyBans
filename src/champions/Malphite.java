...
public class Malphite {
    ...
    @SerializedName("info")
    private Info__68 info;
    @SerializedName("image")
    private Image__68 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__68 stats;
    ...
    @SerializedName("info")
    public Info__68 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__68 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__68 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__68 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__68 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__68 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Malphite.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
