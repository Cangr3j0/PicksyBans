...
public class Info__39 {
    ...
    public String toString() {
        ...
        sb.append(Info__39 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__39) == false) {
            return false;
        }
        Info__39 rhs = ((Info__39) other);
