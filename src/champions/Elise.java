...
public class Elise {
    ...
    @SerializedName("info")
    private Info__25 info;
    @SerializedName("image")
    private Image__25 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__25 stats;
    ...
    @SerializedName("info")
    public Info__25 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__25 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__25 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__25 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__25 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__25 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Elise.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
