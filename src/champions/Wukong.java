...
public class Wukong {
    ...
    @SerializedName("info")
    private Info__73 info;
    @SerializedName("image")
    private Image__73 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__73 stats;
    ...
    @SerializedName("info")
    public Info__73 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__73 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__73 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__73 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__73 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__73 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Wukong.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wukong) == false) {
            return false;
        }
        Wukong rhs = ((Wukong) other);
