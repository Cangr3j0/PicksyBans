...
public class Image__124 {
    ...
    public String toString() {
        ...
        sb.append(Image__124 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__124) == false) {
            return false;
        }
        Image__124 rhs = ((Image__124) other);
