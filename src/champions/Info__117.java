...
public class Info__117 {
    ...
    public String toString() {
        ...
        sb.append(Info__117 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__117) == false) {
            return false;
        }
        Info__117 rhs = ((Info__117) other);
