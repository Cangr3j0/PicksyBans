...
public class Info__103 {
    ...
    public String toString() {
        ...
        sb.append(Info__103 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__103) == false) {
            return false;
        }
        Info__103 rhs = ((Info__103) other);
