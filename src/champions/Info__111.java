...
public class Info__111 {
    ...
    public String toString() {
        ...
        sb.append(Info__111 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__111) == false) {
            return false;
        }
        Info__111 rhs = ((Info__111) other);
