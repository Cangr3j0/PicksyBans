...
public class Ryze {
    ...
    @SerializedName("info")
    private Info__98 info;
    @SerializedName("image")
    private Image__98 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__98 stats;
    ...
    @SerializedName("info")
    public Info__98 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__98 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__98 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__98 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__98 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__98 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Ryze.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
