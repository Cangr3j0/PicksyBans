...
public class Image__29 {
    ...
    public String toString() {
        ...
        sb.append(Image__29 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__29) == false) {
            return false;
        }
        Image__29 rhs = ((Image__29) other);
