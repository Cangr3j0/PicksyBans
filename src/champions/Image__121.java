...
public class Image__121 {
    ...
    public String toString() {
        ...
        sb.append(Image__121 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__121) == false) {
            return false;
        }
        Image__121 rhs = ((Image__121) other);
