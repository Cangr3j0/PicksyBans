...
public class Info__11 {
    ...
    public String toString() {
        ...
        sb.append(Info__11 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__11) == false) {
            return false;
        }
        Info__11 rhs = ((Info__11) other);
