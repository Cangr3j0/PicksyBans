...
public class Info__128 {
    ...
    public String toString() {
        ...
        sb.append(Info__128 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__128) == false) {
            return false;
        }
        Info__128 rhs = ((Info__128) other);
