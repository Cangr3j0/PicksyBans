...
public class Image__39 {
    ...
    public String toString() {
        ...
        sb.append(Image__39 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__39) == false) {
            return false;
        }
        Image__39 rhs = ((Image__39) other);
