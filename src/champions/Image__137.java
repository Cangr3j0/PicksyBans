...
public class Image__137 {
    ...
    public String toString() {
        ...
        sb.append(Image__137 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__137) == false) {
            return false;
        }
        Image__137 rhs = ((Image__137) other);
