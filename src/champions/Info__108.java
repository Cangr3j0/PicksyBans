...
public class Info__108 {
    ...
    public String toString() {
        ...
        sb.append(Info__108 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__108) == false) {
            return false;
        }
        Info__108 rhs = ((Info__108) other);
