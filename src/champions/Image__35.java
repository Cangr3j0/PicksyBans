...
public class Image__35 {
    ...
    public String toString() {
        ...
        sb.append(Image__35 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__35) == false) {
            return false;
        }
        Image__35 rhs = ((Image__35) other);
