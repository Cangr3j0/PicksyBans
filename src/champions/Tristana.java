...
public class Tristana {
    ...
    @SerializedName("info")
    private Info__120 info;
    @SerializedName("image")
    private Image__120 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__120 stats;
    ...
    @SerializedName("info")
    public Info__120 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__120 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__120 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__120 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__120 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__120 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Tristana.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
