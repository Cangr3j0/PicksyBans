...
public class Info__45 {
    ...
    public String toString() {
        ...
        sb.append(Info__45 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__45) == false) {
            return false;
        }
        Info__45 rhs = ((Info__45) other);
