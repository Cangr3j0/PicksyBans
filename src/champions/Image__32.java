...
public class Image__32 {
    ...
    public String toString() {
        ...
        sb.append(Image__32 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__32) == false) {
            return false;
        }
        Image__32 rhs = ((Image__32) other);
