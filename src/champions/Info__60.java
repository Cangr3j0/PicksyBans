...
public class Info__60 {
    ...
    public String toString() {
        ...
        sb.append(Info__60 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__60) == false) {
            return false;
        }
        Info__60 rhs = ((Info__60) other);
