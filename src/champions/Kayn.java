...
public class Kayn {
    ...
    @SerializedName("info")
    private Info__55 info;
    @SerializedName("image")
    private Image__55 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__55 stats;
    ...
    @SerializedName("info")
    public Info__55 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__55 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__55 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__55 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__55 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__55 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Kayn.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Kayn) == false) {
            return false;
        }
        Kayn rhs = ((Kayn) other);
