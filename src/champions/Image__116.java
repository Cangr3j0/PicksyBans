...
public class Image__116 {
    ...
    public String toString() {
        ...
        sb.append(Image__116 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__116) == false) {
            return false;
        }
        Image__116 rhs = ((Image__116) other);
