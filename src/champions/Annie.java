...
public class Annie {
    ...
    @SerializedName("info")
    private Info__6 info;
    @SerializedName("image")
    private Image__6 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__6 stats;
    ...
    @SerializedName("info")
    public Info__6 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__6 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__6 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__6 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__6 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__6 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Annie.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
