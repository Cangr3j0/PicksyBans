...
public class Image__52 {
    ...
    public String toString() {
        ...
        sb.append(Image__52 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__52) == false) {
            return false;
        }
        Image__52 rhs = ((Image__52) other);
