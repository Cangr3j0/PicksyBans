...
public class Darius {
    ...
    @SerializedName("info")
    private Info__20 info;
    @SerializedName("image")
    private Image__20 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__20 stats;
    ...
    @SerializedName("info")
    public Info__20 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__20 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__20 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__20 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__20 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__20 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Darius.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
