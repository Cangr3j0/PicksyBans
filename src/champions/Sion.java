...
public class Sion {
    ...
    @SerializedName("info")
    private Info__106 info;
    @SerializedName("image")
    private Image__106 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__106 stats;
    ...
    @SerializedName("info")
    public Info__106 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__106 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__106 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__106 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__106 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__106 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Sion.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
