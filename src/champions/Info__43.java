...
public class Info__43 {
    ...
    public String toString() {
        ...
        sb.append(Info__43 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__43) == false) {
            return false;
        }
        Info__43 rhs = ((Info__43) other);
