...
public class Image__44 {
    ...
    public String toString() {
        ...
        sb.append(Image__44 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__44) == false) {
            return false;
        }
        Image__44 rhs = ((Image__44) other);
