...
public class Info__29 {
    ...
    public String toString() {
        ...
        sb.append(Info__29 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__29) == false) {
            return false;
        }
        Info__29 rhs = ((Info__29) other);
