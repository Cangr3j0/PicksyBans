...
public class LeeSin {
    ...
    @SerializedName("info")
    private Info__62 info;
    @SerializedName("image")
    private Image__62 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__62 stats;
    ...
    @SerializedName("info")
    public Info__62 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__62 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__62 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__62 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__62 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__62 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(LeeSin.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
