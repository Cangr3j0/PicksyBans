...
public class Info__26 {
    ...
    public String toString() {
        ...
        sb.append(Info__26 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__26) == false) {
            return false;
        }
        Info__26 rhs = ((Info__26) other);
