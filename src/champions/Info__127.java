...
public class Info__127 {
    ...
    public String toString() {
        ...
        sb.append(Info__127 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__127) == false) {
            return false;
        }
        Info__127 rhs = ((Info__127) other);
