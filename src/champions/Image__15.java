...
public class Image__15 {
    ...
    public String toString() {
        ...
        sb.append(Image__15 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__15) == false) {
            return false;
        }
        Image__15 rhs = ((Image__15) other);
