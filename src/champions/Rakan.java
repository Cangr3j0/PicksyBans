...
public class Rakan {
    ...
    @SerializedName("info")
    private Info__91 info;
    @SerializedName("image")
    private Image__91 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__91 stats;
    ...
    @SerializedName("info")
    public Info__91 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__91 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__91 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__91 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__91 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__91 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Rakan.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Rakan) == false) {
            return false;
        }
        Rakan rhs = ((Rakan) other);
