...
public class Info__126 {
    ...
    public String toString() {
        ...
        sb.append(Info__126 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__126) == false) {
            return false;
        }
        Info__126 rhs = ((Info__126) other);
