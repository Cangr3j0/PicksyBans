...
public class Info__71 {
    ...
    public String toString() {
        ...
        sb.append(Info__71 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__71) == false) {
            return false;
        }
        Info__71 rhs = ((Info__71) other);
