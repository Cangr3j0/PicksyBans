...
public class Image__72 {
    ...
    public String toString() {
        ...
        sb.append(Image__72 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__72) == false) {
            return false;
        }
        Image__72 rhs = ((Image__72) other);
