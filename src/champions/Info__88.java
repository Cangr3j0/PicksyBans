...
public class Info__88 {
    ...
    public String toString() {
        ...
        sb.append(Info__88 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__88) == false) {
            return false;
        }
        Info__88 rhs = ((Info__88) other);
