...
public class Info__123 {
    ...
    public String toString() {
        ...
        sb.append(Info__123 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__123) == false) {
            return false;
        }
        Info__123 rhs = ((Info__123) other);
