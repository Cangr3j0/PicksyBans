...
public class Aphelios {
    ...
    @SerializedName("info")
    private Info__7 info;
    @SerializedName("image")
    private Image__7 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__7 stats;
    ...
    @SerializedName("info")
    public Info__7 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__7 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__7 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__7 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__7 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__7 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Aphelios.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Aphelios) == false) {
            return false;
        }
        Aphelios rhs = ((Aphelios) other);
