...
public class Image__143 {
    ...
    public String toString() {
        ...
        sb.append(Image__143 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__143) == false) {
            return false;
        }
        Image__143 rhs = ((Image__143) other);
