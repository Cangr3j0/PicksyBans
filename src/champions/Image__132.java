...
public class Image__132 {
    ...
    public String toString() {
        ...
        sb.append(Image__132 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__132) == false) {
            return false;
        }
        Image__132 rhs = ((Image__132) other);
