...
public class Image__112 {
    ...
    public String toString() {
        ...
        sb.append(Image__112 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__112) == false) {
            return false;
        }
        Image__112 rhs = ((Image__112) other);
