...
public class Image__86 {
    ...
    public String toString() {
        ...
        sb.append(Image__86 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__86) == false) {
            return false;
        }
        Image__86 rhs = ((Image__86) other);
