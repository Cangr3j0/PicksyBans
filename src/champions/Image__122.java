...
public class Image__122 {
    ...
    public String toString() {
        ...
        sb.append(Image__122 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__122) == false) {
            return false;
        }
        Image__122 rhs = ((Image__122) other);
