...
public class AurelionSol {
    ...
    @SerializedName("info")
    private Info__9 info;
    @SerializedName("image")
    private Image__9 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__9 stats;
    ...
    @SerializedName("info")
    public Info__9 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__9 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__9 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__9 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__9 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__9 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(AurelionSol.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AurelionSol) == false) {
            return false;
        }
        AurelionSol rhs = ((AurelionSol) other);
