...
public class Image__84 {
    ...
    public String toString() {
        ...
        sb.append(Image__84 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__84) == false) {
            return false;
        }
        Image__84 rhs = ((Image__84) other);
