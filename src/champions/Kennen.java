...
public class Kennen {
    ...
    @SerializedName("info")
    private Info__56 info;
    @SerializedName("image")
    private Image__56 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__56 stats;
    ...
    @SerializedName("info")
    public Info__56 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__56 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__56 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__56 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__56 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__56 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Kennen.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
