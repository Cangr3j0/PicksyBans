...
public class Image__28 {
    ...
    public String toString() {
        ...
        sb.append(Image__28 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__28) == false) {
            return false;
        }
        Image__28 rhs = ((Image__28) other);
