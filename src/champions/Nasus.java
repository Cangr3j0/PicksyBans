...
public class Nasus {
    ...
    @SerializedName("info")
    private Info__77 info;
    @SerializedName("image")
    private Image__77 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__77 stats;
    ...
    @SerializedName("info")
    public Info__77 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__77 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__77 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__77 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__77 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__77 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Nasus.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
