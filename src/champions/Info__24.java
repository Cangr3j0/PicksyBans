...
public class Info__24 {
    ...
    public String toString() {
        ...
        sb.append(Info__24 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__24) == false) {
            return false;
        }
        Info__24 rhs = ((Info__24) other);
