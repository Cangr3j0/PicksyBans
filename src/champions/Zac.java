...
public class Zac {
    ...
    @SerializedName("info")
    private Info__142 info;
    @SerializedName("image")
    private Image__142 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__142 stats;
    ...
    @SerializedName("info")
    public Info__142 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__142 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__142 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__142 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__142 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__142 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Zac.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
