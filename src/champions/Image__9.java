...
public class Image__9 {
    ...
    public String toString() {
        ...
        sb.append(Image__9 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__9) == false) {
            return false;
        }
        Image__9 rhs = ((Image__9) other);
