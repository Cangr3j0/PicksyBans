...
public class MasterYi {
    ...
    @SerializedName("info")
    private Info__71 info;
    @SerializedName("image")
    private Image__71 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__71 stats;
    ...
    @SerializedName("info")
    public Info__71 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__71 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__71 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__71 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__71 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__71 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(MasterYi.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
