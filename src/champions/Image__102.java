...
public class Image__102 {
    ...
    public String toString() {
        ...
        sb.append(Image__102 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__102) == false) {
            return false;
        }
        Image__102 rhs = ((Image__102) other);
