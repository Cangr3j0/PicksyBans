...
public class Fiora {
    ...
    @SerializedName("info")
    private Info__29 info;
    @SerializedName("image")
    private Image__29 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__29 stats;
    ...
    @SerializedName("info")
    public Info__29 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__29 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__29 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__29 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__29 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__29 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Fiora.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
