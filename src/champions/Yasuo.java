...
public class Yasuo {
    ...
    @SerializedName("info")
    private Info__139 info;
    @SerializedName("image")
    private Image__139 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__139 stats;
    ...
    @SerializedName("info")
    public Info__139 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__139 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__139 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__139 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__139 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__139 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Yasuo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
