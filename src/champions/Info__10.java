...
public class Info__10 {
    ...
    public String toString() {
        ...
        sb.append(Info__10 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__10) == false) {
            return false;
        }
        Info__10 rhs = ((Info__10) other);
