...
public class Image__110 {
    ...
    public String toString() {
        ...
        sb.append(Image__110 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__110) == false) {
            return false;
        }
        Image__110 rhs = ((Image__110) other);
