...
public class Udyr {
    ...
    @SerializedName("info")
    private Info__125 info;
    @SerializedName("image")
    private Image__125 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__125 stats;
    ...
    @SerializedName("info")
    public Info__125 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__125 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__125 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__125 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__125 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__125 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Udyr.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
