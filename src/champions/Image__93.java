...
public class Image__93 {
    ...
    public String toString() {
        ...
        sb.append(Image__93 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__93) == false) {
            return false;
        }
        Image__93 rhs = ((Image__93) other);
