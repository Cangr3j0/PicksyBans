...
public class Info__78 {
    ...
    public String toString() {
        ...
        sb.append(Info__78 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__78) == false) {
            return false;
        }
        Info__78 rhs = ((Info__78) other);
