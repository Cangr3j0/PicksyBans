...
public class Viktor {
    ...
    @SerializedName("info")
    private Info__132 info;
    @SerializedName("image")
    private Image__132 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__132 stats;
    ...
    @SerializedName("info")
    public Info__132 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__132 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__132 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__132 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__132 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__132 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Viktor.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
