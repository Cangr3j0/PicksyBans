...
public class Info__87 {
    ...
    public String toString() {
        ...
        sb.append(Info__87 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__87) == false) {
            return false;
        }
        Info__87 rhs = ((Info__87) other);
