...
public class Jhin {
    ...
    @SerializedName("info")
    private Info__46 info;
    @SerializedName("image")
    private Image__46 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__46 stats;
    ...
    @SerializedName("info")
    public Info__46 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__46 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__46 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__46 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__46 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__46 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Jhin.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Jhin) == false) {
            return false;
        }
        Jhin rhs = ((Jhin) other);
