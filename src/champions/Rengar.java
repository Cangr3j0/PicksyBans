...
public class Rengar {
    ...
    @SerializedName("info")
    private Info__95 info;
    @SerializedName("image")
    private Image__95 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__95 stats;
    ...
    @SerializedName("info")
    public Info__95 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__95 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__95 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__95 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__95 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__95 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Rengar.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
