...
public class Nidalee {
    ...
    @SerializedName("info")
    private Info__80 info;
    @SerializedName("image")
    private Image__80 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__80 stats;
    ...
    @SerializedName("info")
    public Info__80 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__80 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__80 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__80 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__80 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__80 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Nidalee.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
