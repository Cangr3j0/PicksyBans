...
public class Rammus {
    ...
    @SerializedName("info")
    private Info__92 info;
    @SerializedName("image")
    private Image__92 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__92 stats;
    ...
    @SerializedName("info")
    public Info__92 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__92 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__92 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__92 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__92 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__92 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Rammus.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
