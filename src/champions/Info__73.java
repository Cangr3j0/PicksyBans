...
public class Info__73 {
    ...
    public String toString() {
        ...
        sb.append(Info__73 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__73) == false) {
            return false;
        }
        Info__73 rhs = ((Info__73) other);
