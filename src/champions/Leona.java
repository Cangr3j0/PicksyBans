...
public class Leona {
    ...
    @SerializedName("info")
    private Info__63 info;
    @SerializedName("image")
    private Image__63 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__63 stats;
    ...
    @SerializedName("info")
    public Info__63 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__63 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__63 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__63 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__63 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__63 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Leona.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
