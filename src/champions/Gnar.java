...
public class Gnar {
    ...
    @SerializedName("info")
    private Info__34 info;
    @SerializedName("image")
    private Image__34 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__34 stats;
    ...
    @SerializedName("info")
    public Info__34 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__34 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__34 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__34 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__34 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__34 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Gnar.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
