...
public class Info__4 {
    ...
    public String toString() {
        ...
        sb.append(Info__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__4) == false) {
            return false;
        }
        Info__4 rhs = ((Info__4) other);
