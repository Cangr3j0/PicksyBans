...
public class Info__59 {
    ...
    public String toString() {
        ...
        sb.append(Info__59 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__59) == false) {
            return false;
        }
        Info__59 rhs = ((Info__59) other);
