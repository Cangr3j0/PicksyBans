...
public class Image__48 {
    ...
    public String toString() {
        ...
        sb.append(Image__48 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__48) == false) {
            return false;
        }
        Image__48 rhs = ((Image__48) other);
