...
public class Gangplank {
    ...
    @SerializedName("info")
    private Info__32 info;
    @SerializedName("image")
    private Image__32 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__32 stats;
    ...
    @SerializedName("info")
    public Info__32 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__32 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__32 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__32 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__32 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__32 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Gangplank.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
