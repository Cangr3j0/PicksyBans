...
public class Ashe {
    ...
    @SerializedName("info")
    private Info__8 info;
    @SerializedName("image")
    private Image__8 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__8 stats;
    ...
    @SerializedName("info")
    public Info__8 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__8 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__8 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__8 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__8 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__8 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Ashe.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
