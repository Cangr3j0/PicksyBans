...
public class Zed {
    ...
    @SerializedName("info")
    private Info__143 info;
    @SerializedName("image")
    private Image__143 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__143 stats;
    ...
    @SerializedName("info")
    public Info__143 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__143 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__143 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__143 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__143 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__143 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Zed.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
