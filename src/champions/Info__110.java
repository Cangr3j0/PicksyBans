...
public class Info__110 {
    ...
    public String toString() {
        ...
        sb.append(Info__110 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__110) == false) {
            return false;
        }
        Info__110 rhs = ((Info__110) other);
