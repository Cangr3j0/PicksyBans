...
public class Info__132 {
    ...
    public String toString() {
        ...
        sb.append(Info__132 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__132) == false) {
            return false;
        }
        Info__132 rhs = ((Info__132) other);
