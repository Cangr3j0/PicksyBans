...
public class Zoe {
    ...
    @SerializedName("info")
    private Info__146 info;
    @SerializedName("image")
    private Image__146 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__146 stats;
    ...
    @SerializedName("info")
    public Info__146 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__146 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__146 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__146 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__146 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__146 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Zoe.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
