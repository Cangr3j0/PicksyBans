...
public class Image__95 {
    ...
    public String toString() {
        ...
        sb.append(Image__95 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__95) == false) {
            return false;
        }
        Image__95 rhs = ((Image__95) other);
