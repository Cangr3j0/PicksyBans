...
public class Info__97 {
    ...
    public String toString() {
        ...
        sb.append(Info__97 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__97) == false) {
            return false;
        }
        Info__97 rhs = ((Info__97) other);
