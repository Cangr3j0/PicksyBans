...
public class Image__55 {
    ...
    public String toString() {
        ...
        sb.append(Image__55 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__55) == false) {
            return false;
        }
        Image__55 rhs = ((Image__55) other);
