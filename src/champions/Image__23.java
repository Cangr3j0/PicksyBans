...
public class Image__23 {
    ...
    public String toString() {
        ...
        sb.append(Image__23 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__23) == false) {
            return false;
        }
        Image__23 rhs = ((Image__23) other);
