...
public class Image__139 {
    ...
    public String toString() {
        ...
        sb.append(Image__139 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__139) == false) {
            return false;
        }
        Image__139 rhs = ((Image__139) other);
