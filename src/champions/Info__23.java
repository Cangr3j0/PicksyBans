...
public class Info__23 {
    ...
    public String toString() {
        ...
        sb.append(Info__23 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__23) == false) {
            return false;
        }
        Info__23 rhs = ((Info__23) other);
