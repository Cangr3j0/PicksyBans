...
public class Image__69 {
    ...
    public String toString() {
        ...
        sb.append(Image__69 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__69) == false) {
            return false;
        }
        Image__69 rhs = ((Image__69) other);
