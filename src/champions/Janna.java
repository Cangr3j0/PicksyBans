...
public class Janna {
    ...
    @SerializedName("info")
    private Info__42 info;
    @SerializedName("image")
    private Image__42 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__42 stats;
    ...
    @SerializedName("info")
    public Info__42 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__42 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__42 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__42 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__42 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__42 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Janna.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
