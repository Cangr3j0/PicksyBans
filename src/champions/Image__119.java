...
public class Image__119 {
    ...
    public String toString() {
        ...
        sb.append(Image__119 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__119) == false) {
            return false;
        }
        Image__119 rhs = ((Image__119) other);
