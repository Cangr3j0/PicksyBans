...
public class Info__77 {
    ...
    public String toString() {
        ...
        sb.append(Info__77 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__77) == false) {
            return false;
        }
        Info__77 rhs = ((Info__77) other);
