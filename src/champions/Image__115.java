...
public class Image__115 {
    ...
    public String toString() {
        ...
        sb.append(Image__115 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__115) == false) {
            return false;
        }
        Image__115 rhs = ((Image__115) other);
