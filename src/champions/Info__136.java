...
public class Info__136 {
    ...
    public String toString() {
        ...
        sb.append(Info__136 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__136) == false) {
            return false;
        }
        Info__136 rhs = ((Info__136) other);
