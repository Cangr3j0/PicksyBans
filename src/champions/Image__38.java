...
public class Image__38 {
    ...
    public String toString() {
        ...
        sb.append(Image__38 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__38) == false) {
            return false;
        }
        Image__38 rhs = ((Image__38) other);
