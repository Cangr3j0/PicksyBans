...
public class Info__90 {
    ...
    public String toString() {
        ...
        sb.append(Info__90 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__90) == false) {
            return false;
        }
        Info__90 rhs = ((Info__90) other);
