...
public class Image__59 {
    ...
    public String toString() {
        ...
        sb.append(Image__59 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__59) == false) {
            return false;
        }
        Image__59 rhs = ((Image__59) other);
