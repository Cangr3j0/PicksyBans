...
public class Info__100 {
    ...
    public String toString() {
        ...
        sb.append(Info__100 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__100) == false) {
            return false;
        }
        Info__100 rhs = ((Info__100) other);
