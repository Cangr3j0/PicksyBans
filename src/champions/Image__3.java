...
public class Image__3 {
    ...
    public String toString() {
        ...
        sb.append(Image__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__3) == false) {
            return false;
        }
        Image__3 rhs = ((Image__3) other);
