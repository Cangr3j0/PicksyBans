...
public class Tryndamere {
    ...
    @SerializedName("info")
    private Info__122 info;
    @SerializedName("image")
    private Image__122 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__122 stats;
    ...
    @SerializedName("info")
    public Info__122 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__122 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__122 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__122 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__122 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__122 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Tryndamere.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
