...
public class Image__2 {
    ...
    public String toString() {
        ...
        sb.append(Image__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__2) == false) {
            return false;
        }
        Image__2 rhs = ((Image__2) other);
