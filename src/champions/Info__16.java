...
public class Info__16 {
    ...
    public String toString() {
        ...
        sb.append(Info__16 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__16) == false) {
            return false;
        }
        Info__16 rhs = ((Info__16) other);
