...
public class Morgana {
    ...
    @SerializedName("info")
    private Info__75 info;
    @SerializedName("image")
    private Image__75 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__75 stats;
    ...
    @SerializedName("info")
    public Info__75 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__75 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__75 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__75 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__75 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__75 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Morgana.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
