...
public class Image__54 {
    ...
    public String toString() {
        ...
        sb.append(Image__54 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__54) == false) {
            return false;
        }
        Image__54 rhs = ((Image__54) other);
