...
public class Image__94 {
    ...
    public String toString() {
        ...
        sb.append(Image__94 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__94) == false) {
            return false;
        }
        Image__94 rhs = ((Image__94) other);
