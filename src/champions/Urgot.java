...
public class Urgot {
    ...
    @SerializedName("info")
    private Info__126 info;
    @SerializedName("image")
    private Image__126 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__126 stats;
    ...
    @SerializedName("info")
    public Info__126 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__126 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__126 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__126 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__126 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__126 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Urgot.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
