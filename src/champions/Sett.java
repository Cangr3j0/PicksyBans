...
public class Sett {
    ...
    @SerializedName("info")
    private Info__101 info;
    @SerializedName("image")
    private Image__101 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__101 stats;
    ...
    @SerializedName("info")
    public Info__101 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__101 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__101 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__101 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__101 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__101 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Sett.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Sett) == false) {
            return false;
        }
        Sett rhs = ((Sett) other);
