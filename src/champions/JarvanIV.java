...
public class JarvanIV {
    ...
    @SerializedName("info")
    private Info__43 info;
    @SerializedName("image")
    private Image__43 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__43 stats;
    ...
    @SerializedName("info")
    public Info__43 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__43 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__43 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__43 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__43 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__43 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(JarvanIV.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
