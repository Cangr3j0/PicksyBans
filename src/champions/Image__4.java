...
public class Image__4 {
    ...
    public String toString() {
        ...
        sb.append(Image__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__4) == false) {
            return false;
        }
        Image__4 rhs = ((Image__4) other);
