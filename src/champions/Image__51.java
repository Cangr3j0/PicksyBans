...
public class Image__51 {
    ...
    public String toString() {
        ...
        sb.append(Image__51 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__51) == false) {
            return false;
        }
        Image__51 rhs = ((Image__51) other);
