...
public class Image__91 {
    ...
    public String toString() {
        ...
        sb.append(Image__91 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__91) == false) {
            return false;
        }
        Image__91 rhs = ((Image__91) other);
