...
public class Thresh {
    ...
    @SerializedName("info")
    private Info__119 info;
    @SerializedName("image")
    private Image__119 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__119 stats;
    ...
    @SerializedName("info")
    public Info__119 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__119 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__119 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__119 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__119 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__119 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Thresh.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
