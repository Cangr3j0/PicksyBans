...
public class Singed {
    ...
    @SerializedName("info")
    private Info__105 info;
    @SerializedName("image")
    private Image__105 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__105 stats;
    ...
    @SerializedName("info")
    public Info__105 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__105 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__105 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__105 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__105 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__105 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Singed.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
