...
public class Info__38 {
    ...
    public String toString() {
        ...
        sb.append(Info__38 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__38) == false) {
            return false;
        }
        Info__38 rhs = ((Info__38) other);
