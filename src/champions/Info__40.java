...
public class Info__40 {
    ...
    public String toString() {
        ...
        sb.append(Info__40 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__40) == false) {
            return false;
        }
        Info__40 rhs = ((Info__40) other);
