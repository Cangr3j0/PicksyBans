...
public class Velkoz {
    ...
    @SerializedName("info")
    private Info__130 info;
    @SerializedName("image")
    private Image__130 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__130 stats;
    ...
    @SerializedName("info")
    public Info__130 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__130 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__130 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__130 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__130 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__130 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Velkoz.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
