...
public class Corki {
    ...
    @SerializedName("info")
    private Info__19 info;
    @SerializedName("image")
    private Image__19 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__19 stats;
    ...
    @SerializedName("info")
    public Info__19 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__19 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__19 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__19 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__19 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__19 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Corki.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
