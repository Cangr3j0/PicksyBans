...
public class Image__74 {
    ...
    public String toString() {
        ...
        sb.append(Image__74 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__74) == false) {
            return false;
        }
        Image__74 rhs = ((Image__74) other);
