...
public class Image__89 {
    ...
    public String toString() {
        ...
        sb.append(Image__89 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__89) == false) {
            return false;
        }
        Image__89 rhs = ((Image__89) other);
