...
public class Image__96 {
    ...
    public String toString() {
        ...
        sb.append(Image__96 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__96) == false) {
            return false;
        }
        Image__96 rhs = ((Image__96) other);
