...
public class Orianna {
    ...
    @SerializedName("info")
    private Info__84 info;
    @SerializedName("image")
    private Image__84 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__84 stats;
    ...
    @SerializedName("info")
    public Info__84 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__84 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__84 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__84 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__84 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__84 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Orianna.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
