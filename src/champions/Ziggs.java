...
public class Ziggs {
    ...
    @SerializedName("info")
    private Info__144 info;
    @SerializedName("image")
    private Image__144 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__144 stats;
    ...
    @SerializedName("info")
    public Info__144 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__144 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__144 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__144 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__144 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__144 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Ziggs.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
