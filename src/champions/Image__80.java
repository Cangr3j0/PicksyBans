...
public class Image__80 {
    ...
    public String toString() {
        ...
        sb.append(Image__80 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__80) == false) {
            return false;
        }
        Image__80 rhs = ((Image__80) other);
