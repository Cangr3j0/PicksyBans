...
public class Info__76 {
    ...
    public String toString() {
        ...
        sb.append(Info__76 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__76) == false) {
            return false;
        }
        Info__76 rhs = ((Info__76) other);
