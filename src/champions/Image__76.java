...
public class Image__76 {
    ...
    public String toString() {
        ...
        sb.append(Image__76 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__76) == false) {
            return false;
        }
        Image__76 rhs = ((Image__76) other);
