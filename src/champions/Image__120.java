...
public class Image__120 {
    ...
    public String toString() {
        ...
        sb.append(Image__120 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__120) == false) {
            return false;
        }
        Image__120 rhs = ((Image__120) other);
