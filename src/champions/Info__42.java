...
public class Info__42 {
    ...
    public String toString() {
        ...
        sb.append(Info__42 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__42) == false) {
            return false;
        }
        Info__42 rhs = ((Info__42) other);
