...
public class Info__135 {
    ...
    public String toString() {
        ...
        sb.append(Info__135 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__135) == false) {
            return false;
        }
        Info__135 rhs = ((Info__135) other);
