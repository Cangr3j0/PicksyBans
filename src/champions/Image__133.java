...
public class Image__133 {
    ...
    public String toString() {
        ...
        sb.append(Image__133 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__133) == false) {
            return false;
        }
        Image__133 rhs = ((Image__133) other);
