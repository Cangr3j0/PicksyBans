...
public class Info__54 {
    ...
    public String toString() {
        ...
        sb.append(Info__54 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__54) == false) {
            return false;
        }
        Info__54 rhs = ((Info__54) other);
