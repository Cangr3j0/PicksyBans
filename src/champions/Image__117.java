...
public class Image__117 {
    ...
    public String toString() {
        ...
        sb.append(Image__117 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__117) == false) {
            return false;
        }
        Image__117 rhs = ((Image__117) other);
