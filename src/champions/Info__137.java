...
public class Info__137 {
    ...
    public String toString() {
        ...
        sb.append(Info__137 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__137) == false) {
            return false;
        }
        Info__137 rhs = ((Info__137) other);
