...
public class Katarina {
    ...
    @SerializedName("info")
    private Info__53 info;
    @SerializedName("image")
    private Image__53 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__53 stats;
    ...
    @SerializedName("info")
    public Info__53 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__53 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__53 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__53 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__53 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__53 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Katarina.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
