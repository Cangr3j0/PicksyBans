...
public class Info__70 {
    ...
    public String toString() {
        ...
        sb.append(Info__70 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__70) == false) {
            return false;
        }
        Info__70 rhs = ((Info__70) other);
