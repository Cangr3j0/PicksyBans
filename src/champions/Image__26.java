...
public class Image__26 {
    ...
    public String toString() {
        ...
        sb.append(Image__26 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__26) == false) {
            return false;
        }
        Image__26 rhs = ((Image__26) other);
