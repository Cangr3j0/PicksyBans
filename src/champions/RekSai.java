...
public class RekSai {
    ...
    @SerializedName("info")
    private Info__93 info;
    @SerializedName("image")
    private Image__93 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__93 stats;
    ...
    @SerializedName("info")
    public Info__93 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__93 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__93 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__93 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__93 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__93 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(RekSai.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
