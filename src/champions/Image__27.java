...
public class Image__27 {
    ...
    public String toString() {
        ...
        sb.append(Image__27 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__27) == false) {
            return false;
        }
        Image__27 rhs = ((Image__27) other);
