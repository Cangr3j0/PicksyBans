...
public class Image__19 {
    ...
    public String toString() {
        ...
        sb.append(Image__19 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__19) == false) {
            return false;
        }
        Image__19 rhs = ((Image__19) other);
