...
public class Image__129 {
    ...
    public String toString() {
        ...
        sb.append(Image__129 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__129) == false) {
            return false;
        }
        Image__129 rhs = ((Image__129) other);
