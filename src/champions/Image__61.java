...
public class Image__61 {
    ...
    public String toString() {
        ...
        sb.append(Image__61 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__61) == false) {
            return false;
        }
        Image__61 rhs = ((Image__61) other);
