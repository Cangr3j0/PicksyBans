...
public class Evelynn {
    ...
    @SerializedName("info")
    private Info__26 info;
    @SerializedName("image")
    private Image__26 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__26 stats;
    ...
    @SerializedName("info")
    public Info__26 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__26 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__26 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__26 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__26 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__26 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Evelynn.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
