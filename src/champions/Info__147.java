...
public class Info__147 {
    ...
    public String toString() {
        ...
        sb.append(Info__147 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__147) == false) {
            return false;
        }
        Info__147 rhs = ((Info__147) other);
