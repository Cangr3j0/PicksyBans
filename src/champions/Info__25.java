...
public class Info__25 {
    ...
    public String toString() {
        ...
        sb.append(Info__25 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__25) == false) {
            return false;
        }
        Info__25 rhs = ((Info__25) other);
