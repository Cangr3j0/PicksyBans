...
public class Khazix {
    ...
    @SerializedName("info")
    private Info__57 info;
    @SerializedName("image")
    private Image__57 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__57 stats;
    ...
    @SerializedName("info")
    public Info__57 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__57 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__57 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__57 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__57 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__57 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Khazix.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
