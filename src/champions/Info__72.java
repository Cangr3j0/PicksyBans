...
public class Info__72 {
    ...
    public String toString() {
        ...
        sb.append(Info__72 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__72) == false) {
            return false;
        }
        Info__72 rhs = ((Info__72) other);
