...
public class Image__33 {
    ...
    public String toString() {
        ...
        sb.append(Image__33 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__33) == false) {
            return false;
        }
        Image__33 rhs = ((Image__33) other);
