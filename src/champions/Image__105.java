...
public class Image__105 {
    ...
    public String toString() {
        ...
        sb.append(Image__105 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__105) == false) {
            return false;
        }
        Image__105 rhs = ((Image__105) other);
