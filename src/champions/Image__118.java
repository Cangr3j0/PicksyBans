...
public class Image__118 {
    ...
    public String toString() {
        ...
        sb.append(Image__118 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__118) == false) {
            return false;
        }
        Image__118 rhs = ((Image__118) other);
