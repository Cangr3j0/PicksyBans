...
public class Info__48 {
    ...
    public String toString() {
        ...
        sb.append(Info__48 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__48) == false) {
            return false;
        }
        Info__48 rhs = ((Info__48) other);
