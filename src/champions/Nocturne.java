...
public class Nocturne {
    ...
    @SerializedName("info")
    private Info__81 info;
    @SerializedName("image")
    private Image__81 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__81 stats;
    ...
    @SerializedName("info")
    public Info__81 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__81 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__81 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__81 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__81 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__81 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Nocturne.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
