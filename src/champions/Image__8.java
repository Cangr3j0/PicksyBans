...
public class Image__8 {
    ...
    public String toString() {
        ...
        sb.append(Image__8 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__8) == false) {
            return false;
        }
        Image__8 rhs = ((Image__8) other);
