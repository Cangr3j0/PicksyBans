...
public class Sejuani {
    ...
    @SerializedName("info")
    private Info__99 info;
    @SerializedName("image")
    private Image__99 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__99 stats;
    ...
    @SerializedName("info")
    public Info__99 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__99 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__99 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__99 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__99 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__99 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Sejuani.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
