...
public class Pantheon {
    ...
    @SerializedName("info")
    private Info__86 info;
    @SerializedName("image")
    private Image__86 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__86 stats;
    ...
    @SerializedName("info")
    public Info__86 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__86 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__86 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__86 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__86 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__86 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Pantheon.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
