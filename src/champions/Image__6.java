...
public class Image__6 {
    ...
    public String toString() {
        ...
        sb.append(Image__6 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__6) == false) {
            return false;
        }
        Image__6 rhs = ((Image__6) other);
