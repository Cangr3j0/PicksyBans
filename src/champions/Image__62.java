...
public class Image__62 {
    ...
    public String toString() {
        ...
        sb.append(Image__62 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__62) == false) {
            return false;
        }
        Image__62 rhs = ((Image__62) other);
