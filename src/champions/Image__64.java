...
public class Image__64 {
    ...
    public String toString() {
        ...
        sb.append(Image__64 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__64) == false) {
            return false;
        }
        Image__64 rhs = ((Image__64) other);
