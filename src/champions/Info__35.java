...
public class Info__35 {
    ...
    public String toString() {
        ...
        sb.append(Info__35 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__35) == false) {
            return false;
        }
        Info__35 rhs = ((Info__35) other);
