...
public class Image__141 {
    ...
    public String toString() {
        ...
        sb.append(Image__141 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__141) == false) {
            return false;
        }
        Image__141 rhs = ((Image__141) other);
