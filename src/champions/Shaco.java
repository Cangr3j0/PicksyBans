...
public class Shaco {
    ...
    @SerializedName("info")
    private Info__102 info;
    @SerializedName("image")
    private Image__102 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__102 stats;
    ...
    @SerializedName("info")
    public Info__102 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__102 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__102 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__102 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__102 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__102 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Shaco.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
