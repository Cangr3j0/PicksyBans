...
public class Info__58 {
    ...
    public String toString() {
        ...
        sb.append(Info__58 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__58) == false) {
            return false;
        }
        Info__58 rhs = ((Info__58) other);
