...
public class Info__81 {
    ...
    public String toString() {
        ...
        sb.append(Info__81 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__81) == false) {
            return false;
        }
        Info__81 rhs = ((Info__81) other);
