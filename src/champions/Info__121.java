...
public class Info__121 {
    ...
    public String toString() {
        ...
        sb.append(Info__121 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__121) == false) {
            return false;
        }
        Info__121 rhs = ((Info__121) other);
