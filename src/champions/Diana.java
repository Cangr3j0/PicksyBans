...
public class Diana {
    ...
    @SerializedName("info")
    private Info__21 info;
    @SerializedName("image")
    private Image__21 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__21 stats;
    ...
    @SerializedName("info")
    public Info__21 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__21 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__21 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__21 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__21 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__21 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Diana.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
