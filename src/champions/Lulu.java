...
public class Lulu {
    ...
    @SerializedName("info")
    private Info__66 info;
    @SerializedName("image")
    private Image__66 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__66 stats;
    ...
    @SerializedName("info")
    public Info__66 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__66 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__66 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__66 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__66 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__66 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Lulu.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
