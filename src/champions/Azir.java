...
public class Azir {
    ...
    @SerializedName("info")
    private Info__10 info;
    @SerializedName("image")
    private Image__10 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__10 stats;
    ...
    @SerializedName("info")
    public Info__10 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__10 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__10 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__10 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__10 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__10 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Azir.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
