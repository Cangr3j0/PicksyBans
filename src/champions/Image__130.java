...
public class Image__130 {
    ...
    public String toString() {
        ...
        sb.append(Image__130 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__130) == false) {
            return false;
        }
        Image__130 rhs = ((Image__130) other);
