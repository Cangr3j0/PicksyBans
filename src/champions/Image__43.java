...
public class Image__43 {
    ...
    public String toString() {
        ...
        sb.append(Image__43 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__43) == false) {
            return false;
        }
        Image__43 rhs = ((Image__43) other);
