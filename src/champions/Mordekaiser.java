...
public class Mordekaiser {
    ...
    @SerializedName("info")
    private Info__74 info;
    @SerializedName("image")
    private Image__74 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__74 stats;
    ...
    @SerializedName("info")
    public Info__74 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__74 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__74 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__74 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__74 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__74 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Mordekaiser.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
