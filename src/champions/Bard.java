...
public class Bard {
    ...
    @SerializedName("info")
    private Info__11 info;
    @SerializedName("image")
    private Image__11 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__11 stats;
    ...
    @SerializedName("info")
    public Info__11 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__11 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__11 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__11 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__11 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__11 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Bard.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
