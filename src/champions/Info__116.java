...
public class Info__116 {
    ...
    public String toString() {
        ...
        sb.append(Info__116 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("attack");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Info__116) == false) {
            return false;
        }
        Info__116 rhs = ((Info__116) other);
