...
public class Image__21 {
    ...
    public String toString() {
        ...
        sb.append(Image__21 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__21) == false) {
            return false;
        }
        Image__21 rhs = ((Image__21) other);
