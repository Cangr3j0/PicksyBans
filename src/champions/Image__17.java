...
public class Image__17 {
    ...
    public String toString() {
        ...
        sb.append(Image__17 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("full");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Image__17) == false) {
            return false;
        }
        Image__17 rhs = ((Image__17) other);
