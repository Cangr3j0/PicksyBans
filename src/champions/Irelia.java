...
public class Irelia {
    ...
    @SerializedName("info")
    private Info__40 info;
    @SerializedName("image")
    private Image__40 image;
    @SerializedName("tags")
    private List<String> tags = new ArrayList<String>();
    @SerializedName("partype")
    private String partype;
    @SerializedName("stats")
    private Stats__40 stats;
    ...
    @SerializedName("info")
    public Info__40 getInfo() {
        return info;
    }

    @SerializedName("info")
    public void setInfo(Info__40 info) {
        this.info = info;
    }

    @SerializedName("image")
    public Image__40 getImage() {
        return image;
    }

    @SerializedName("image")
    public void setImage(Image__40 image) {
        this.image = image;
    }
    ...
    @SerializedName("stats")
    public Stats__40 getStats() {
        return stats;
    }

    @SerializedName("stats")
    public void setStats(Stats__40 stats) {
        this.stats = stats;
    }
    ...
    public String toString() {
        ...
        sb.append(Irelia.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("version");
        sb.append('=');
