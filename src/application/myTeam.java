...
private String entitledFeaturedType;
...
public String getEntitledFeaturedType() {
	return entitledFeaturedType;
}
public void setEntitledFeaturedType(String entitledFeaturedType) {
	this.entitledFeaturedType = entitledFeaturedType;
}
